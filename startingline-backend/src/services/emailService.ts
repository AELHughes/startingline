...
class EmailService {
  ...
  private generateEventRegistrationHTML(data: EventRegistrationEmailData): string {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  async sendEventRegistrationEmail(data: EventRegistrationEmailData): Promise<boolean> {
    try {
