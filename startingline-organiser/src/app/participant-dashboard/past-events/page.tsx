...
import { Calendar, MapPin, Clock, Download, History, Users, AlertCircle } from 'lucide-react'
      ...
      <div className="bg-gray-50 min-h-screen">
        <div className="p-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">You need to be signed in to view your event history.</p>
            <Link href="/login">
      ...
      <div className="bg-gray-50 min-h-screen">
        <div className="p-6">
          <div className="text-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-4">Error Loading Past Events</h1>
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="p-6">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Past Events</h1>
          <p className="text-gray-600">Your completed events and race history</p>
        </div>
                      ...
                      {order.tickets.map((ticket) => (
                        <div key={ticket.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                          ...
                          <div className="flex items-center gap-2">
                            <span className="text-sm font-medium">R{ticket.amount}</span>
                            <Button
                              variant="outline"
                              size="sm"
