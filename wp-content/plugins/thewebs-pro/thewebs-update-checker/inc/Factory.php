<?php
if ( !class_exists('Thewebs_Update_Checker', false) ) :
	 ...
	 * versions by calling {@link Thewebs_Update_Checker::addVersion()}.
	 *
	 * At the moment it can only build instances of the UpdateChecker class. Other classes are
	 * intended mainly for internal use and refer directly to specific implementations.
	 */
	class Thewebs_Update_Checker {
		 ...
		 * @return Thewebs_Puc_Plugin_UpdateChecker|Thewebs_Puc_Theme_UpdateChecker|Thewebs_Puc_Vcs_BaseChecker
		 */
		 ...
		 *
		 * @see Thewebs_Puc_UpdateChecker::__construct
		 *
		 ...
		 * @return Thewebs_Puc_Plugin_UpdateChecker|Thewebs_Puc_Theme_UpdateChecker
		 */
		public static function buildUpdateChecker($metadataUrl, $fullPath, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = '') {
			...
			if ( self::isPluginFile($fullPath) ) {
				$type = 'Plugin';
				$id = $fullPath;
				$checkerClass = 'Thewebs_Puc_Plugin_UpdateChecker';
			} else if ( $themeDirectory !== null ) {
				$type = 'Theme';
				$id = $themeDirectory;
				$checkerClass = 'Thewebs_Puc_Theme_UpdateChecker';
			} else {
