<?php
if ( !class_exists('Thewebs_Puc_Plugin_UpdateChecker', false) ):
	 ...
	 * @access public
	 */
	class Thewebs_Puc_Plugin_UpdateChecker extends Thewebs_Puc_UpdateChecker {
		...
		/**
		 * @var Thewebs_Puc_Plugin_Package
		 */
		protected $package;
		...
		public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = ''){
			...
			$this->extraUi = new Thewebs_Puc_Plugin_Ui($this);
		}
		 ...
		 * @return Thewebs_Puc_Scheduler
		 */
		protected function createScheduler($checkPeriod) {
			$scheduler = new Thewebs_Puc_Scheduler($this, $checkPeriod, array('load-plugins.php'));
		 ...
		 * @return Thewebs_Puc_Plugin_Info
		 */
		public function requestInfo($queryArgs = array()) {
			list($pluginInfo, $result) = $this->requestMetadata('Thewebs_Puc_Plugin_Info', 'request_info', $queryArgs);

			if ( $pluginInfo !== null ) {
				/** @var Thewebs_Puc_Plugin_Info $pluginInfo */
		 ...
		 *
		 * @return Thewebs_Puc_Update|null An instance of Plugin_Update, or NULL when no updates are available.
		 */
		public function requestUpdate() {
			...
			$update = Thewebs_Puc_Plugin_Update::fromPluginInfo($pluginInfo);
		 ...
		 *
		 * @return Thewebs_Puc_Plugin_Update|null
		 */
		public function getUpdate() {
			$update = parent::getUpdate();
			if ( isset($update) ) {
				/** @var Thewebs_Puc_Plugin_Update $update */
		 ...
		 *
		 * @return Thewebs_Puc_InstalledPackage
		 */
		protected function createInstalledPackage() {
			return new Thewebs_Puc_Plugin_Package($this->pluginAbsolutePath, $this);
		}

		/**
		 * @return Thewebs_Puc_Plugin_Package
		 */
