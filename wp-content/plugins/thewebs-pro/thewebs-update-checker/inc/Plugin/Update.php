<?php
if ( !class_exists('Thewebs_Puc_Plugin_Update', false) ):
	 ...
	 * @access public
	 */
	class Thewebs_Puc_Plugin_Update extends Thewebs_Puc_Update {
		public $id = 0;
		public $homepage;
		...
		public static function fromJson($json){
			...
			$pluginInfo = Thewebs_Puc_Plugin_Info::fromJson($json);
			if ( $pluginInfo !== null ) {
		 ...
		 *
		 * @param Thewebs_Puc_Plugin_Info $info
		 * @return Thewebs_Puc_Plugin_Update
		 */
		 ...
		 *
		 * @param StdClass|Thewebs_Puc_Plugin_Info|Thewebs_Puc_Plugin_Update $object The source object.
		 * @return Thewebs_Puc_Plugin_Update The new copy.
		 */
