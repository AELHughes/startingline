...
if ( !class_exists('Thewebs_Puc_UpdateChecker', false) ):

	abstract class Thewebs_Puc_UpdateChecker {
		...
		/**
		 * @var Thewebs_Puc_InstalledPackage
		 */
		protected $package;

		/**
		 * @var Thewebs_Puc_Scheduler
		 */
		public $scheduler;

		/**
		 * @var Thewebs_Puc_UpgraderStatus
		 */
		protected $upgraderStatus;

		/**
		 * @var Thewebs_Puc_StateStore
		 */
		...
		public function __construct($metadataUrl, $directoryName, $slug = null, $checkPeriod = 2, $optionName = '') {
			...
			$this->upgraderStatus = new Thewebs_Puc_UpgraderStatus();
			$this->updateState = new Thewebs_Puc_StateStore($this->optionName);
		 ...
		 *
		 * @return Thewebs_Puc_Update|null
		 */
		 ...
		 *
		 * @return Thewebs_Puc_Update An instance of Update, or NULL when no updates are available.
		 */
		 ...
		 *
		 * @param Thewebs_Puc_Metadata|null $update
		 */
		protected function fixSupportedWordpressVersion(Thewebs_Puc_Metadata $update = null) {
		 ...
		 * @return array [Thewebs_Puc_Metadata|null, array|WP_Error] A metadata instance and the value returned by wp_remote_get().
		 */
