<?php
if ( !class_exists('Thewebs_Puc_Scheduler', false) ):

	/**
	 * The scheduler decides when and how often to check for updates.
	 * It calls @see Thewebs_Puc_UpdateChecker::checkForUpdates() to perform the actual checks.
	 */
	class Thewebs_Puc_Scheduler {
		 ...
		 *
		 * @param Thewebs_Puc_UpdateChecker $updateChecker
		...
		public function upgraderProcessComplete(
			...
			if ( is_a($this->updateChecker, 'Thewebs_Puc_Theme_UpdateChecker') ) {
			...
			if ( is_a($this->updateChecker, 'Thewebs_Puc_Plugin_UpdateChecker') ) {
