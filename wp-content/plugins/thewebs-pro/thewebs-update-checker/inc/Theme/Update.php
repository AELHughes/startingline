...
if ( !class_exists('Thewebs_Puc_Theme_Update', false) ):

	class Thewebs_Puc_Theme_Update extends Thewebs_Puc_Update {
		public $details_url = '';
		 ...
		 *
		 * @param StdClass|Thewebs_Puc_Theme_Update $object The source object.
		 * @return Thewebs_Puc_Theme_Update The new copy.
		 */
