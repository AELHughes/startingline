...
if ( !class_exists('Thewebs_Puc_Theme_UpdateChecker', false) ):

	class Thewebs_Puc_Theme_UpdateChecker extends Thewebs_Puc_UpdateChecker {
		 ...
		 *
		 * @return Thewebs_Puc_Update|null An instance of Update, or NULL when no updates are available.
		 */
		public function requestUpdate() {
			list($themeUpdate, $result) = $this->requestMetadata('Thewebs_Puc_Theme_Update', 'request_update');

			if ( $themeUpdate !== null ) {
				/** @var Thewebs_Puc_Theme_Update $themeUpdate */
		...
		protected function createScheduler($checkPeriod) {
			return new Thewebs_Puc_Scheduler($this, $checkPeriod, array('load-themes.php'));
		}
		...
		protected function createInstalledPackage() {
			return new Thewebs_Puc_Theme_Package($this->stylesheet, $this);
		}
	}
