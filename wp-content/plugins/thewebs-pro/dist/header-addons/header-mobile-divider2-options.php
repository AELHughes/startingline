...
$settings = array(
	'header_mobile_divider2_border' => array(
		...
		'label'        => esc_html__( 'Mobile Divider 2', 'thewebs-pro' ),
		'default'      => thewebs()->default( 'header_mobile_divider2_border' ),
		'live_method'     => array(
			array(
				'type'     => 'css_border',
	...
	'header_mobile_divider2_height' => array(
		...
		'default'      => thewebs()->default( 'header_mobile_divider2_height' ),
		'input_attrs'  => array(
			'min'     => array(
				'%'  => 0,
				'px'  => 0,
	...
	'header_mobile_divider2_margin' => array(
		...
		'section'      => 'header_mobile_divider2',
		'priority'     => 10,
		'default'      => thewebs()->default( 'header_mobile_divider2_margin' ),
	...
	'transparent_header_mobile_divider2_color' => array(
		...
		'label'        => esc_html__( 'Mobile Divider 2 Color', 'thewebs-pro' ),
		'default'      => thewebs()->default( 'transparent_header_mobile_divider2_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
