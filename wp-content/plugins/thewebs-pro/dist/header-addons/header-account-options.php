...
$settings = array(
	...
	'header_account_preview' => array(
		...
		'section'      => 'header_account',
		'default'      => thewebs()->default( 'header_account_preview' ),
	...
	'header_account_style' => array(
		'control_type' => 'thewebs_radio_icon_control',
		'section'      => 'header_account',
		'default'      => thewebs()->default( 'header_account_style' ),
		'label'        => esc_html__( 'Account Style', 'thewebs-pro' ),
		'partial'      => array(
			'selector'            => '.header-account-wrap',
			'container_inclusive' => true,
			'render_callback'     => 'Thewebs_Pro\header_account',
		),
		'context'      => array(
			array(
				'setting'    => 'header_account_preview',
	...
	'header_account_label' => array(
		...
		'default'      => thewebs()->default( 'header_account_label' ),
	...
	'header_account_icon' => array(
		'control_type' => 'thewebs_radio_icon_control',
		'section'      => 'header_account',
		'default'      => thewebs()->default( 'header_account_icon' ),
	...
	'header_account_action' => array(
		'control_type' => 'thewebs_radio_icon_control',
		'section'      => 'header_account',
		'default'      => thewebs()->default( 'header_account_action' ),
		...
		'input_attrs'  => array(
			'layout' => array(
				...
				'dropdown' => array(
					'name' => __( 'Dropdown Menu', 'thewebs-pro' ),
				),
				'modal' => array(
	...
	'header_account_dropdown_direction' => array(
		'control_type' => 'thewebs_radio_icon_control',
		'section'      => 'header_account',
		'default'      => thewebs()->default( 'header_account_dropdown_direction' ),
		'label'        => esc_html__( 'Dropdown Direction', 'thewebs-pro' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
				'setting'    => 'header_account_preview',
	...
	'header_account_modal_registration' => array(
		...
		'default'      => thewebs()->default( 'header_account_modal_registration' ),
	...
	'header_account_link' => array(
		...
		'default'      => thewebs()->default( 'header_account_link' ),
		'partial'      => array(
			'selector'            => '.header-account-wrap',
			'container_inclusive' => true,
			'render_callback'     => 'Thewebs_Pro\header_account',
	...
	'header_account_icon_size' => array(
		...
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.header-account-wrap .header-account-button .nav-drop-title-wrap > .thewebs-svg-iconset, .header-account-wrap .header-account-button > .thewebs-svg-iconset',
				'property' => 'font-size',
				'pattern'  => '$',
				'key'      => 'size',
			),
		...
		'default'      => thewebs()->default( 'header_account_icon_size' ),
		'input_attrs'  => array(
			'min'        => array(
				'px'  => 0,
				'em'  => 0,
	...
	'header_account_color' => array(
		...
		'default'      => thewebs()->default( 'header_account_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'header_account_background' => array(
		...
		'default'      => thewebs()->default( 'header_account_background' ),
		'context'      => array(
			array(
				'setting'    => 'header_account_preview',
				'operator'   => '=',
	...
	'header_account_radius' => array(
		...
		'section'      => 'header_account_design',
		'default'      => thewebs()->default( 'header_account_radius' ),
	...
	'header_account_typography' => array(
		...
		'default'      => thewebs()->default( 'header_account_typography' ),
		'context'      => array(
			array(
				'setting'    => 'header_account_style',
				'operator'   => 'contain',
	...
	'header_account_padding' => array(
		'control_type' => 'thewebs_measure_control',
		'section'      => 'header_account_design',
		'default'      => thewebs()->default( 'header_account_padding' ),
	...
	'header_account_margin' => array(
		'control_type' => 'thewebs_measure_control',
		'section'      => 'header_account_design',
		'default'      => thewebs()->default( 'header_account_margin' ),
	...
	'header_account_in_style' => array(
		'control_type' => 'thewebs_radio_icon_control',
		'section'      => 'header_account',
		'default'      => thewebs()->default( 'header_account_in_style' ),
		'label'        => esc_html__( 'Account Style', 'thewebs-pro' ),
		'partial'      => array(
		...
		'input_attrs'  => array(
			'layout' => array(
				...
				'icon_name' => array(
					'name' => __( 'Icon + User Name', 'thewebs-pro' ),
				),
				'name_icon' => array(
					'name' => __( 'User Name + Icon', 'thewebs-pro' ),
				),
			),
			'responsive' => false,
			'class'      => 'thewebs-two-forced',
	...
	'header_account_in_label' => array(
		...
		'section'      => 'header_account',
		'sanitize'     => 'sanitize_text_field',
		'default'      => thewebs()->default( 'header_account_in_label' ),
		'label'        => esc_html__( 'Account Label', 'thewebs-pro' ),
		'context'      => array(
			array(
	...
	'header_account_in_icon' => array(
		'control_type' => 'thewebs_radio_icon_control',
		'section'      => 'header_account',
		'default'      => thewebs()->default( 'header_account_in_icon' ),
		'label'        => esc_html__( 'Account Icon', 'thewebs-pro' ),
		'partial'      => array(
			'selector'            => '.header-account-in-wrap',
			'container_inclusive' => true,
	...
	'header_account_in_action' => array(
		'control_type' => 'thewebs_radio_icon_control',
		'section'      => 'header_account',
		'default'      => thewebs()->default( 'header_account_in_action' ),
		'label'        => esc_html__( 'Account Action', 'thewebs-pro' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
	...
	'header_account_in_dropdown_source' => array(
		'control_type' => 'thewebs_radio_icon_control',
		'section'      => 'header_account',
		'default'      => thewebs()->default( 'header_account_in_dropdown_source' ),
		'label'        => esc_html__( 'Dropdown Source', 'thewebs-pro' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
		...
		'input_attrs'  => array(
			'layout' => array(
				'navigation' => array(
					'name' => __( 'Navigation Menu', 'thewebs-pro' ),
				),
				'woocommerce' => array(
					'name' => __( 'Woocommerce Account Menu', 'thewebs-pro' ),
				),
			),
			'responsive' => false,
			'class'      => 'thewebs-two-forced',
	...
	'header_account_in_dropdown_direction' => array(
		'control_type' => 'thewebs_radio_icon_control',
		'section'      => 'header_account',
		'default'      => thewebs()->default( 'header_account_in_dropdown_direction' ),
		'label'        => esc_html__( 'Dropdown Direction', 'thewebs-pro' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
	...
	'header_account_in_link' => array(
		...
		'sanitize'     => 'esc_url_raw',
		'label'        => esc_html__( 'Account Item Link', 'thewebs-pro' ),
		'default'      => thewebs()->default( 'header_account_in_link' ),
		'partial'      => array(
			'selector'            => '.header-account-in-wrap',
			'container_inclusive' => true,
			'render_callback'     => 'Thewebs_Pro\header_account',
	...
	'header_account_in_icon_size' => array(
		...
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.header-account-in-wrap .header-account-button .nav-drop-title-wrap > .thewebs-svg-iconset, .header-account-in-wrap .header-account-button > .thewebs-svg-iconset',
				'property' => 'font-size',
				'pattern'  => '$',
				'key'      => 'size',
			),
		...
		'default'      => thewebs()->default( 'header_account_in_icon_size' ),
		'input_attrs'  => array(
			'min'        => array(
				'px'  => 0,
				'em'  => 0,
	...
	'header_account_in_image_radius' => array(
		'control_type' => 'thewebs_measure_control',
		'section'      => 'header_account_design',
		'default'      => thewebs()->default( 'header_account_in_image_radius' ),
	...
	'header_account_in_color' => array(
		...
		'section'      => 'header_account_design',
		'label'        => esc_html__( 'Account Colors', 'thewebs-pro' ),
		'default'      => thewebs()->default( 'header_account_in_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'header_account_in_background' => array(
		...
		'section'      => 'header_account_design',
		'label'        => esc_html__( 'Account Background', 'thewebs-pro' ),
		'default'      => thewebs()->default( 'header_account_in_background' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.site-header-item .header-account-in-wrap .header-account-button',
	...
	'header_account_in_radius' => array(
		'control_type' => 'thewebs_measure_control',
		'section'      => 'header_account_design',
		'default'      => thewebs()->default( 'header_account_in_radius' ),
		'label'        => esc_html__( 'Border Radius', 'thewebs-pro' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'header_account_in_typography' => array(
		...
		'default'      => thewebs()->default( 'header_account_in_typography' ),
		'context'      => array(
			array(
				'setting'    => 'header_account_preview',
				'operator'   => '=',
	...
	'header_account_in_padding' => array(
		'control_type' => 'thewebs_measure_control',
		'section'      => 'header_account_design',
		'default'      => thewebs()->default( 'header_account_in_padding' ),
		'label'        => esc_html__( 'Padding', 'thewebs-pro' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'header_account_in_margin' => array(
		'control_type' => 'thewebs_measure_control',
		'section'      => 'header_account_design',
		'default'      => thewebs()->default( 'header_account_in_margin' ),
		'label'        => esc_html__( 'Margin', 'thewebs-pro' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'transparent_header_account_color' => array(
		...
		'default'      => thewebs()->default( 'transparent_header_account_color' ),
		'context'      => array(
			array(
				'setting'  => '__device',
				'operator' => 'in',
	...
	'transparent_header_account_background' => array(
		...
		'default'      => thewebs()->default( 'transparent_header_account_background' ),
		'context'      => array(
			array(
				'setting'  => '__device',
				'operator' => 'in',
	...
	'transparent_header_account_in_color' => array(
		...
		'default'      => thewebs()->default( 'transparent_header_account_in_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'transparent_header_account_in_background' => array(
		...
		'default'      => thewebs()->default( 'transparent_header_account_in_background' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.transparent-header .site-header-item .header-account-in-wrap .header-account-button',
