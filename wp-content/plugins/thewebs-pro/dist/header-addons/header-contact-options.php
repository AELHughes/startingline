...
$settings = array(
	...
	'header_contact_items' => array(
		...
		'section'      => 'header_contact',
		'priority'     => 6,
		'default'      => thewebs()->default( 'header_contact_items' ),
		'label'        => esc_html__( 'Contact Items', 'thewebs-pro' ),
		'partial'      => array(
			'selector'            => '.header-contact-wrap',
			'container_inclusive' => true,
			'render_callback'     => 'Thewebs_Pro\header_contact',
		),
	),
	'header_contact_item_spacing' => array(
		'control_type' => 'thewebs_range_control',
		'section'      => 'header_contact_design',
		'label'        => esc_html__( 'Item Spacing', 'thewebs-pro' ),
		'default'      => thewebs()->default( 'header_contact_item_spacing' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'header_contact_icon_size' => array(
		...
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '#main-header .element-contact-inner-wrap .header-contact-item .thewebs-svg-iconset',
				'property' => 'font-size',
				'pattern'  => '$',
				'key'      => 'size',
			),
		),
		'default'      => thewebs()->default( 'header_contact_icon_size' ),
		'input_attrs'  => array(
			'min'        => array(
				'px'  => 0,
				'em'  => 0,
	...
	'header_contact_color' => array(
		...
		'default'      => thewebs()->default( 'header_contact_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'header_contact_link_style' => array(
		...
		'section'      => 'header_contact_design',
		'default'      => thewebs()->default( 'header_contact_link_style' ),
	...
	'header_contact_typography' => array(
		...
		'default'      => thewebs()->default( 'header_contact_typography' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
				'selector' => '#main-header .header-contact-wrap .header-contact-item',
	...
	'header_contact_margin' => array(
		...
		'section'      => 'header_contact_design',
		'priority'     => 10,
		'default'      => thewebs()->default( 'header_contact_margin' ),
	...
	'sticky_header_contact_color' => array(
		...
		'default'      => thewebs()->default( 'sticky_header_contact_color' ),
		'priority'     => 11,
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '#masthead .thewebs-sticky-header.item-is-fixed:not(.item-at-start) .header-contact-wrap .header-contact-item, #masthead .thewebs-sticky-header.item-is-fixed:not(.item-at-start) .header-mobile-contact-wrap .element-contact-inner-wrap .header-contact-item',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'color',
			),
			array(
				'type'     => 'css',
				'selector' => '#masthead .thewebs-sticky-header.item-is-fixed:not(.item-at-start) .header-contact-wrap a.header-contact-item:hover, #masthead .thewebs-sticky-header.item-is-fixed:not(.item-at-start) .header-mobile-contact-wrap .element-contact-inner-wrap .header-contact-item:hover',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'hover',
			),
	...
	'transparent_header_contact_color' => array(
		...
		'label'        => esc_html__( 'Contact Colors', 'thewebs-pro' ),
		'default'      => thewebs()->default( 'transparent_header_contact_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
