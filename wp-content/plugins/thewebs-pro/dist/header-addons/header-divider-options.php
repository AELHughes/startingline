...
$settings = array(
	'header_divider_border' => array(
		...
		'default'      => thewebs()->default( 'header_divider_border' ),
		'live_method'     => array(
			array(
				'type'     => 'css_border',
	...
	'header_divider_height' => array(
		...
		'default'      => thewebs()->default( 'header_divider_height' ),
		'input_attrs'  => array(
			'min'     => array(
				'%'  => 0,
				'px'  => 0,
	...
	'header_divider_margin' => array(
		...
		'section'      => 'header_divider',
		'priority'     => 10,
		'default'      => thewebs()->default( 'header_divider_margin' ),
	...
	'transparent_header_divider_color' => array(
		...
		'label'        => esc_html__( 'Divider Color', 'thewebs-pro' ),
		'default'      => thewebs()->default( 'transparent_header_divider_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
