...
class FooEvents_Woo_Helper {
	...
	public function add_product_options_tab_options() {
		...
		$woocommerce_events_ticket_addtowallet_logo      = get_post_meta( $post->ID, 'WooCommerceEventsTicketAddToWalletLogo', true );
		$woocommerce_events_ticket_display_addtowallet   = get_post_meta( $post->ID, 'WooCommerceEventsTicketDisplayAddToWallet', true );
	...
	public function process_meta_box( $post_id ) {
		...
		if ( isset( $_POST['WooCommerceEventsTicketAddToWalletLogo'] ) ) {

			$woocommerce_events_ticket_addtowallet_logo = sanitize_text_field( wp_unslash( $_POST['WooCommerceEventsTicketAddToWalletLogo'] ) );
			update_post_meta( $post_id, 'WooCommerceEventsTicketAddToWalletLogo', $woocommerce_events_ticket_addtowallet_logo );
		...
		if ( isset( $_POST['WooCommerceEventsTicketDisplayAddToWallet'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification.Missing
			...
			$woocommerce_events_ticket_display_addtowallet = sanitize_text_field( wp_unslash( $_POST['WooCommerceEventsTicketDisplayAddToWallet'] ) ); // phpcs:ignore WordPress.Security.NonceVerification.Missing
			update_post_meta( $post_id, 'WooCommerceEventsTicketDisplayAddToWallet', $woocommerce_events_ticket_display_addtowallet );
