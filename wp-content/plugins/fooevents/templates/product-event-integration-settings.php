	...
	<?php if ( ! empty( $addtowallet_api_key ) ) : ?>
		...
		<div class="options_group">
			<p class="form-field">
				...
				<input type="checkbox" name="WooCommerceEventsTicketDisplayAddToWallet" value="on" <?php echo ( 'on' === $woocommerce_events_ticket_display_addtowallet ) ? 'CHECKED' : ''; ?>>
		...
		<div class="options_group">
			<?php $woocommerce_events_ticket_addtowallet_logo = ( empty( $woocommerce_events_ticket_addtowallet_logo ) ) ? $global_woocommerce_events_ticket_addtowallet_logo : $woocommerce_events_ticket_addtowallet_logo; ?>
			<p class="form-field">
				<label><?php esc_attr_e( 'AddToWallet logo:', 'woocommerce-events' ); ?></label>
				<input id="WooCommerceEventsTicketAddToWalletLogo" class="text uploadfield" type="text" size="40" name="WooCommerceEventsTicketAddToWalletLogo" value="<?php echo esc_attr( $woocommerce_events_ticket_addtowallet_logo ); ?>" />				
