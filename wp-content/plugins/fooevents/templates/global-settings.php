				...
				<td>
					...
					<select name="globalWooCommerceEventsAppEventIDs[]" id="globalWooCommerceEventsAppEventIDs" multiple class="fooevents-multiselect" <?php echo ( 'id' !== $global_woocommerce_events_app_events ) ? 'disabled' : ''; ?>>
						...
						foreach ( $woocommerce_events_app_events as $woocommerce_events_app_event ) {
							?>
								<option value="<?php echo esc_attr( $woocommerce_events_app_event['id'] ); ?>" <?php echo ! empty( $global_woocommerce_events_app_event_ids ) && in_array( (string) $woocommerce_events_app_event['id'], $global_woocommerce_events_app_event_ids, true ) ? 'SELECTED' : ''; ?>><?php echo esc_attr( $woocommerce_events_app_event['title'] ); ?></option>
							<?php
						}
						?>
					</select>
