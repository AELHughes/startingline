...
== Description ==
Thewebs Theme is a lightweight yet full featured WordPress theme for creating beautiful fast loading and accessible websites, easier than ever. It features an easy to use drag and drop header and footer builder to build any type of header in minutes. It features a full library of gorgeous starter temples that are easy to modify with our intelligent global font and color controls. With extensive integration with the most popular 3rd party plugins, you can quickly build impressive ecommerce websites, course websites, business websites, and more.

== License ==
Thewebs is released under GNU General Public License v3.0 (or later)
...
* Fix: Editor Spacing of thewebs buttons.
...
* Update: Filter for adding custom fonts, option to use beaver builder markup 'thewebs_theme_add_custom_fonts'.
* Update: Google Fonts.
...
* Update: Use Thewebs theme colors by default for learndash.
...
* Remove: Customizer Import Export (Required by WordPress.org, now part of Thewebs Starter Templates).
* Remove: Author Social Meta (Required by WordPress.org, now part of Thewebs Starter Templates).
...
* Update: Better support for Thewebs Galleries.
...
* Add: Support for Thewebs Custom Fonts.
...
= Credit =
The Thewebs Theme is based from the Rig Starter Theme:
https://wprig.io/
...
** Mock Logo 1 : https://www.thewebswp.com/alogo/
** Mock Logo 2 : https://www.thewebswp.com/alogo/
** Mock Logo 3 : https://www.thewebswp.com/alogo/
** Mock Logo 4 : https://www.thewebswp.com/alogo/
** Mock Logo 5 : https://www.thewebswp.com/alogo/
** Mock Logo 6 : https://www.thewebswp.com/alogo/
