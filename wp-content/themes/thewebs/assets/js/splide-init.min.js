	...
	window.thewebsSlide = {
		...
		start: function( element ) {
			...
			var options = {
				...
				i18n: {
					...
					prev: prevLabel,
					next: nextLabel,
					slideLabel: '%s ' + thewebsSlideConfig.of + ' %s',
				},
				breakpoints: {
					543: {
						perPage: ss,
		...
		init: function() {
			if ( typeof Splide == 'function' ) {
				...
				var initLoadDelay = setInterval( function(){ if ( typeof Splide == 'function' ) { window.thewebsSlide.initAll(); clearInterval(initLoadDelay); } }, 200 );
			}
		}
	}
