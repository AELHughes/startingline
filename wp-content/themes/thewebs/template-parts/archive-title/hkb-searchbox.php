...
<form class="hkb-site-search search-form" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label class="hkb-screen-reader-text screen-reader-text" for="s"><?php esc_html_e( 'Search For', 'thewebs' ); ?></label>
	...
	<?php } ?>
	<button class="hkb-site-search__button search-submit" type="submit"><span><?php esc_html_e( 'Search', 'thewebs' ); ?></span></button>
	<div class="thewebs-search-icon-wrap"><?php thewebs()->print_icon( 'search', '', false ); ?></div>
</form>
