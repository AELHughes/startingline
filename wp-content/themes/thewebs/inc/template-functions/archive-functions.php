...
function get_archive_hero_classes() {
	...
	$classes[] = 'entry-hero-layout-' . ( thewebs()->option( $slug . '_archive_title_inner_layout' ) ? thewebs()->option( $slug . '_archive_title_inner_layout' ) : 'inherit' );

	return apply_filters( 'thewebs_archive_hero_classes', $classes );
}
...
function get_archive_post_type_slug() {
	...
	return apply_filters( 'thewebs_archive_post_type_slug', $slug );
}
...
function get_archive_title_classes() {
	...
	$classes[] = 'title-align-' . ( thewebs()->sub_option( $slug . '_archive_title_align', 'desktop' ) ? thewebs()->sub_option( $slug . '_archive_title_align', 'desktop' ) : 'inherit' );
	$classes[] = 'title-tablet-align-' . ( thewebs()->sub_option( $slug . '_archive_title_align', 'tablet' ) ? thewebs()->sub_option( $slug . '_archive_title_align', 'tablet' ) : 'inherit' );
	$classes[] = 'title-mobile-align-' . ( thewebs()->sub_option( $slug . '_archive_title_align', 'mobile' ) ? thewebs()->sub_option( $slug . '_archive_title_align', 'mobile' ) : 'inherit' );
	return apply_filters( 'thewebs_archive_title_classes', $classes );
}
...
function get_archive_container_classes() {
	...
	if ( is_search() ) {
		...
		if ( '1' === thewebs()->option( 'search_archive_columns' ) ) {
			$placement    = thewebs()->option( 'search_archive_item_image_placement' );
			$classes[] = 'grid-sm-col-1';
			$classes[] = 'grid-lg-col-1';
			$classes[] = 'item-image-style-' . $placement;
		} elseif ( '2' === thewebs()->option( 'search_archive_columns' ) ) {
			$classes[] = 'grid-sm-col-2';
			$classes[] = 'grid-lg-col-2';
			$classes[] = 'item-image-style-above';
		} elseif ( '4' === thewebs()->option( 'search_archive_columns' ) ) {
			$classes[] = 'grid-sm-col-2';
		...
		if ( '1' === thewebs()->option( 'post_archive_columns' ) ) {
			$placement    = thewebs()->option( 'post_archive_item_image_placement' );
			if ( 'beside' === $placement ) {
				$classes[] = 'item-content-vertical-align-' . thewebs()->option( 'post_archive_item_vertical_alignment', 'top' );
			}
			$classes[] = 'grid-sm-col-1';
			$classes[] = 'grid-lg-col-1';
			$classes[] = 'item-image-style-' . $placement;
		} elseif ( '2' === thewebs()->option( 'post_archive_columns' ) ) {
			$classes[] = 'grid-sm-col-2';
			$classes[] = 'grid-lg-col-2';
			$classes[] = 'item-image-style-above';
		} elseif ( '4' === thewebs()->option( 'post_archive_columns' ) ) {
			$classes[] = 'grid-sm-col-2';
			$classes[] = 'grid-lg-col-4';
			$classes[] = 'item-image-style-above';
		} else {
	...
	} elseif ( thewebs()->option( get_post_type() . '_archive_columns' ) ) {
		$classes[] = get_post_type() . '-archive';
		if ( '1' === thewebs()->option( get_post_type() . '_archive_columns' ) ) {
			$placement = thewebs()->option( get_post_type() . '_archive_item_image_placement', 'above' );
			$classes[] = 'grid-sm-col-1';
			$classes[] = 'grid-lg-col-1';
			$classes[] = 'item-image-style-' . $placement;
		} elseif ( '2' === thewebs()->option( get_post_type() . '_archive_columns' ) ) {
			$classes[] = 'grid-sm-col-2';
			$classes[] = 'grid-lg-col-2';
			$classes[] = 'item-image-style-above';
		} elseif ( '4' === thewebs()->option( get_post_type() . '_archive_columns' ) ) {
			$classes[] = 'grid-sm-col-2';
			$classes[] = 'grid-lg-col-4';
			$classes[] = 'item-image-style-above';
		} else {
	...
	return apply_filters( 'thewebs_archive_container_classes', $classes );
}
...
function get_archive_infinite_attributes() {
	$attributes = '';
	return apply_filters( 'thewebs_archive_infinite_attributes', $attributes );
}
/**
