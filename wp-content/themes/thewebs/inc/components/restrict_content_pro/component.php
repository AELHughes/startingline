<?php
/**
 * Thewebs\Restrict_Content_Pro\Component class
 *
 * @package thewebs
 */

namespace Thewebs\Restrict_Content_Pro;
...
class Component implements Component_Interface {
	...
	public function add_styles() {
		wp_enqueue_style( 'thewebs-rcp', get_theme_file_uri( '/assets/css/rcp.min.css' ), array(), THEWEBS_VERSION );
	}
}
