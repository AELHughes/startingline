<?php
/**
 * Thewebs\Polylang\Component class
 *
 * @package thewebs
 */

namespace Thewebs\Polylang;
...
class Component implements Component_Interface {
	...
	public function add_styles() {
		wp_enqueue_style( 'thewebs-polylang', get_theme_file_uri( '/assets/css/polylang.min.css' ), array(), THEWEBS_VERSION );
	}
}
