<?php
/**
 * Thewebs\Icons\Component class
 *
 * @package thewebs
 */

namespace Thewebs\Icons;
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function get_icon( $icon = 'search', $icon_title = '', $base = true, $aria = false ) {
		$display_title = apply_filters( 'thewebs_svg_icons_have_title', true );
		$output = '<span class="thewebs-svg-iconset' . ( $base ? ' svg-baseline' : '' ) . '">';
		switch ( $icon ) {
			case 'moon':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-moon-svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Dark Mode', 'thewebs' ) ) . '</title>';
				}
				$output .= '<path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path>
				</svg>';
				break;
			case 'moonAlt':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-moon-alt-svg" fill="currentColor" version="1.1" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Dark Mode', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'sun':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-sun-svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Light Mode', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'sunAlt':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-sun-alt-svg" fill="currentColor" version="1.1" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Light Mode', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'sunrise':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-sunrise-svg" fill="currentColor" version="1.1" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Light Mode', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'sunset':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-sunset-svg" fill="currentColor" version="1.1" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Dark Mode', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'settings':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-settings-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Settings', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'home':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-home-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Home', 'thewebs' ) ) . '</title>';
				}
				$output .= '<path d="M9.984 20.016h-4.969v-8.016h-3l9.984-9 9.984 9h-3v8.016h-4.969v-6h-4.031v6z"></path>
				</svg>';
				break;
			case 'search':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-search-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="26" height="28" viewBox="0 0 320.17 320.37">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Search', 'thewebs' ) ) . '</title>';
				}
				$output .= '<path d="M233.89,255.86c-64.52,51.42-154,37.39-201.42-21.13C-13.26,178.3-10.39,96.81,39.21,45.27,90.56-8.1,171.37-15.21,229.72,28.88c32.2,24.32,51.34,56.76,56.46,96.8,5.09,39.88-5.55,75.78-30.81,108.56a25,25,0,0,1,3.81,2.54q27.72,27.6,55.36,55.28c4.38,4.36,6.56,9.44,5.26,15.56a15.94,15.94,0,0,1-26.12,8.79c-1.61-1.37-3.06-2.94-4.56-4.43q-26.47-26.46-52.93-53A24.11,24.11,0,0,1,233.89,255.86ZM255.5,144C255.75,82.37,206,32.39,144.17,32.07a111.83,111.83,0,1,0-4,223.62l1.39,0h2C205.22,255.89,255.26,205.94,255.5,144Z"></path>
				</svg>';
				break;
			case 'search2':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-search2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Search', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'zoom':
				$output .= '<svg class="thewebs-svg-icon thewebs-zoom-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="26" height="28" viewBox="0 0 320.17 320.37">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Zoom In', 'thewebs' ) ) . '</title>';
				}
				$output .= '<path d="M233.89,255.86c-64.52,51.42-154,37.39-201.42-21.13C-13.26,178.3-10.39,96.81,39.21,45.27,90.56-8.1,171.37-15.21,229.72,28.88c32.2,24.32,51.34,56.76,56.46,96.8,5.09,39.88-5.55,75.78-30.81,108.56a25,25,0,0,1,3.81,2.54q27.72,27.6,55.36,55.28c4.38,4.36,6.56,9.44,5.26,15.56a15.94,15.94,0,0,1-26.12,8.79c-1.61-1.37-3.06-2.94-4.56-4.43q-26.47-26.46-52.93-53A24.11,24.11,0,0,1,233.89,255.86ZM255.5,144C255.75,82.37,206,32.39,144.17,32.07a111.83,111.83,0,1,0-4,223.62l1.39,0h2C205.22,255.89,255.26,205.94,255.5,144Z"></path>
				</svg>';
				break;
			case 'bag':
				$output .= '<svg class="thewebs-svg-icon thewebs-bag-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Bag', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'facebook':
				$output .= '<svg class="thewebs-svg-icon thewebs-facebook-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Facebook', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'facebookAlt':
				$output .= '<svg class="thewebs-svg-icon thewebs-facebook-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Facebook', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'facebookAlt2':
				$output .= '<svg class="thewebs-svg-icon thewebs-facebook-alt2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="28" viewBox="0 0 16 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Facebook', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'twitter':
				$output .= '<svg class="thewebs-svg-icon thewebs-twitter-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Twitter', 'thewebs' ) ) . '</title>';
				}
				$output .= '<path d="M 6.9199219 6 L 21.136719 26.726562 L 6.2285156 44 L 9.40625 44 L 22.544922 28.777344 L 32.986328 44 L 43 44 L 28.123047 22.3125 L 42.203125 6 L 39.027344 6 L 26.716797 20.261719 L 16.933594 6 L 6.9199219 6 z"></path>
				</svg>';
				break;
			case 'twitterAlt':
				$output .= '<svg class="thewebs-svg-icon thewebs-twitter-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Twitter', 'thewebs' ) ) . '</title>';
				}
				$output .= '<path d="M 5.9199219 6 L 20.582031 27.375 L 6.2304688 44 L 9.4101562 44 L 21.986328 29.421875 L 31.986328 44 L 44 44 L 28.681641 21.669922 L 42.199219 6 L 39.029297 6 L 27.275391 19.617188 L 17.933594 6 L 5.9199219 6 z M 9.7167969 8 L 16.880859 8 L 40.203125 42 L 33.039062 42 L 9.7167969 8 z"></path>
				</svg>';
				break;
			case 'tiktok':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-tiktok-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'TikTok', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'discord':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-discord-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Discord', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'instagram':
				$output .= '<svg class="thewebs-svg-icon thewebs-instagram-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Instagram', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'instagramAlt':
				$output .= '<svg class="thewebs-svg-icon thewebs-instagram-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Instagram', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'vimeo':
				$output .= '<svg class="thewebs-svg-icon thewebs-vimeo-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Vimeo', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'youtube':
				$output .= '<svg class="thewebs-svg-icon thewebs-youtube-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'YouTube', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'youtubeAlt':
				$output .= '<svg class="thewebs-svg-icon thewebs-youtube-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'YouTube', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'github':
				$output .= '<svg class="thewebs-svg-icon thewebs-github-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Github', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'githubAlt':
				$output .= '<svg class="thewebs-svg-icon thewebs-github-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Github', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'rss':
				$output .= '<svg class="thewebs-svg-icon thewebs-rss-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'RSS', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'rssAlt':
				$output .= '<svg class="thewebs-svg-icon thewebs-rss-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'RSS', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'facebook_group':
				$output .= '<svg class="thewebs-svg-icon thewebs-facebook-group-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="30" height="28" viewBox="0 0 30 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Facebook Group', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'dribbble':
				$output .= '<svg class="thewebs-svg-icon thewebs-dribbble-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Dribbble', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'xing':
				$output .= '<svg class="thewebs-svg-icon thewebs-xing-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="22" height="28" viewBox="0 0 22 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Xing', 'thewebs' ) ) . '</title>';
				}
			...
			case 'wordpress': // phpcs:ignore WordPress.WP.CapitalPDangit.Misspelled
				$output .= '<svg class="thewebs-svg-icon thewebs-wordpress-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'WordPress', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'whatsapp':
				$output .= '<svg class="thewebs-svg-icon thewebs-whatsapp-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'WhatsApp', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'vk':
				$output .= '<svg class="thewebs-svg-icon thewebs-vk-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="31" height="28" viewBox="0 0 31 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'VK', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'tumblr':
				$output .= '<svg class="thewebs-svg-icon thewebs-tumblr-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="17" height="28" viewBox="0 0 17 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Tumblr', 'thewebs' ) ) . '</title>';
				}
				$output .= '<path d="M14.75 20.766l1.25 3.703c-0.469 0.703-2.594 1.5-4.5 1.531-5.672 0.094-7.812-4.031-7.812-6.937v-8.5h-2.625v-3.359c3.938-1.422 4.891-4.984 5.109-7.016 0.016-0.125 0.125-0.187 0.187-0.187h3.813v6.625h5.203v3.937h-5.219v8.094c0 1.094 0.406 2.609 2.5 2.562 0.688-0.016 1.609-0.219 2.094-0.453z"></path>
				</svg>';
				break;
			case 'reddit':
				$output .= '<svg class="thewebs-svg-icon thewebs-reddit-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Reddit', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'redditAlt':
				$output .= '<svg class="thewebs-svg-icon thewebs-reddit-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Reddit', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'patreon':
				$output .= '<svg class="thewebs-svg-icon thewebs-patreon-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Patreon', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'medium':
				$output .= '<svg class="thewebs-svg-icon thewebs-medium-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Medium', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'behance':
				$output .= '<svg class="thewebs-svg-icon thewebs-behance-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="28" viewBox="0 0 32 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Behance', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'anchor':
				$output .= '<svg class="thewebs-svg-icon thewebs-anchor-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Anchor', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'soundcloud':
				$output .= '<svg class="thewebs-svg-icon thewebs-soundcloud-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'SoundCloud', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'soundcloudAlt':
				$output .= '<svg class="thewebs-svg-icon thewebs-soundcloud-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'SoundCloud', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'email':
				$output .= '<svg class="thewebs-svg-icon thewebs-email-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Email', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'emailAlt':
				$output .= '<svg class="thewebs-svg-icon thewebs-email-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Email', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'emailAlt2':
				$output .= '<svg class="thewebs-svg-icon thewebs-email-alt2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Email', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'phone':
				$output .= '<svg class="thewebs-svg-icon thewebs-phone-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Phone', 'thewebs' ) ) . '</title>';
				}
				$output .= '<path d="M18.9456 14.8612C18.1152 14.0308 17.2872 13.2006 16.457 12.3724C15.7984 11.6804 14.9348 11.6804 14.2428 12.3724C13.7248 12.8904 13.2048 13.4082 12.6872 13.9282C12.5486 14.0666 12.4438 14.0666 12.272 13.9974C11.9594 13.7898 11.58 13.6514 11.2676 13.4438C9.78101 12.5108 8.50221 11.299 7.39501 9.915C6.84161 9.223 6.35701 8.4978 6.01121 7.6674C5.94201 7.4956 5.94201 7.3906 6.08041 7.2524C6.63401 6.768 7.11841 6.2502 7.63601 5.7992C8.36381 5.0738 8.36381 4.2436 7.63601 3.5182C7.18741 3.0674 6.80581 2.688 6.39281 2.2728C5.94201 1.8242 5.52681 1.4088 5.11181 0.9938C4.45561 0.3354 3.58961 0.3354 2.89981 0.9938C2.37981 1.5118 1.86181 2.0294 1.34181 2.5496C0.857608 3.0338 0.616608 3.6208 0.547408 4.2794C0.478208 5.3506 0.719208 6.3886 1.10081 7.3906C1.86201 9.5 3.03821 11.299 4.45561 12.993C6.35721 15.276 8.67401 17.1088 11.3368 18.39C12.5488 18.9434 13.7942 19.4278 15.1066 19.497C16.0752 19.5304 16.872 19.2894 17.5282 18.5618C17.977 18.0774 18.497 17.6288 18.9456 17.1444C19.6376 16.4168 19.6376 15.553 18.9456 14.8612Z"></path>
				</svg>';
				break;
			case 'phoneAlt':
				$output .= '<svg class="thewebs-svg-icon thewebs-phone-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Phone', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'phoneAlt2':
				$output .= '<svg class="thewebs-svg-icon thewebs-phone-alt2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Phone', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'google_reviews':
				$output .= '<svg class="thewebs-svg-icon thewebs-google-reviews-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Google Reviews', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'telegram':
				$output .= '<svg class="thewebs-svg-icon thewebs-telegram-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Telegram', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'telegramAlt':
				$output .= '<svg class="thewebs-svg-icon thewebs-telegram-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Telegram', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'trip_advisor':
				$output .= '<svg class="thewebs-svg-icon thewebs-trip-advisor-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="36" height="28" viewBox="0 0 36 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Trip Advisor', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'yelp':
				$output .= '<svg class="thewebs-svg-icon thewebs-yelp-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Yelp', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'user':
				$output .= '<svg class="thewebs-svg-icon thewebs-user-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'User', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'comments':
				$output .= '<svg class="thewebs-svg-icon thewebs-comments-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Comments', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'commentsAlt':
				$output .= '<svg class="thewebs-svg-icon thewebs-comments-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Comments', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'folder':
				$output .= '<svg class="thewebs-svg-icon thewebs-comments-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="26" height="28" viewBox="0 0 26 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Categories', 'thewebs' ) ) . '</title>';
				}
			...
			case 'gridlarge':
				...
				break;
			case 'list':
				$output .= '<svg class="thewebs-svg-icon thewebs-list-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 371.81 384">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'List', 'thewebs' ) ) . '</title>';
				}
				$output .= '<path d="M182.25,0q0,56.75-.07,113.51,0,32,0,64.06c0,1.36,0,2.71,0,4.61H4.87c-1.62,0-3.24,0-4.87.07V0H182.25ZM24.1,157.85H157.93V24.3H24.1V157.85Z"/><path d="M0,201.75l113.51,0.07h68.67v5q0,86.16,0,172.32c0,1.62,0,3.24.07,4.87H0V201.75ZM157.91,359.83V226H24.24V359.83H157.91Z"/><path d="M213.94,61.23V37.78H371.81V61.23H213.94Z"/><path d="M371.8,121v23.48H214.09V121H371.8Z"/><path d="M371.8,263.15H214V239.61H371.8v23.53Z"/><path d="M371.81,322.82v23.5H214.07v-23.5H371.81Z"/></path>
				</svg>';
				break;
			case 'account':
				$output .= '<svg class="thewebs-svg-icon thewebs-account-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Account', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'account2':
				$output .= '<svg class="thewebs-svg-icon thewebs-account2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Account', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'account3':
				$output .= '<svg class="thewebs-svg-icon thewebs-account3-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Account', 'thewebs' ) ) . '</title>';
				}
				...
				break;	
			case 'feed':
				$output .= '<svg class="thewebs-svg-icon thewebs-feed-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="22" height="28" viewBox="0 0 22 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'RSS', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'pinterest':
				$output .= '<svg class="thewebs-svg-icon thewebs-pinterest-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Pinterest', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'pinterestAlt':
				$output .= '<svg class="thewebs-svg-icon thewebs-pinterest-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Pinterest', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'mobile':
				$output .= '<svg class="thewebs-svg-icon thewebs-mobile-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Mobile', 'thewebs' ) ) . '</title>';
				}
				$output .= '<path d="M18.9456 14.8612C18.1152 14.0308 17.2872 13.2006 16.457 12.3724C15.7984 11.6804 14.9348 11.6804 14.2428 12.3724C13.7248 12.8904 13.2048 13.4082 12.6872 13.9282C12.5486 14.0666 12.4438 14.0666 12.272 13.9974C11.9594 13.7898 11.58 13.6514 11.2676 13.4438C9.78101 12.5108 8.50221 11.299 7.39501 9.915C6.84161 9.223 6.35701 8.4978 6.01121 7.6674C5.94201 7.4956 5.94201 7.3906 6.08041 7.2524C6.63401 6.768 7.11841 6.2502 7.63601 5.7992C8.36381 5.0738 8.36381 4.2436 7.63601 3.5182C7.18741 3.0674 6.80581 2.688 6.39281 2.2728C5.94201 1.8242 5.52681 1.4088 5.11181 0.9938C4.45561 0.3354 3.58961 0.3354 2.89981 0.9938C2.37981 1.5118 1.86181 2.0294 1.34181 2.5496C0.857608 3.0338 0.616608 3.6208 0.547408 4.2794C0.478208 5.3506 0.719208 6.3886 1.10081 7.3906C1.86201 9.5 3.03821 11.299 4.45561 12.993C6.35721 15.276 8.67401 17.1088 11.3368 18.39C12.5488 18.9434 13.7942 19.4278 15.1066 19.497C16.0752 19.5304 16.872 19.2894 17.5282 18.5618C17.977 18.0774 18.497 17.6288 18.9456 17.1444C19.6376 16.4168 19.6376 15.553 18.9456 14.8612Z"></path>
				</svg>';
				break;
			case 'hours':
				$output .= '<svg class="thewebs-svg-icon thewebs-hours-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Hours', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'hoursAlt':
				$output .= '<svg class="thewebs-svg-icon thewebs-hours-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Hours', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'hoursAlt2':
				$output .= '<svg class="thewebs-svg-icon thewebs-hours-alt2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Hours', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'location':
				$output .= '<svg class="thewebs-svg-icon thewebs-location-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="28" viewBox="0 0 16 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Location', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'locationAlt':
				$output .= '<svg class="thewebs-svg-icon thewebs-location-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Location', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'locationAlt2':
				$output .= '<svg class="thewebs-svg-icon thewebs-location-alt2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Location', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'envelop':
				$output .= '<svg class="thewebs-svg-icon thewebs-envelop-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Envelop', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'linkedin':
				$output .= '<svg class="thewebs-svg-icon thewebs-linkedin-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Linkedin', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'linkedinAlt':
				$output .= '<svg class="thewebs-svg-icon thewebs-linkedin-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Linkedin', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'goodreads':
				$output .= '<svg class="thewebs-svg-icon thewebs-goodreads-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Goodreads', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'amazon':
				$output .= '<svg class="thewebs-svg-icon thewebs-amazon-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Amazon', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'bookbub':
				$output .= '<svg class="thewebs-svg-icon thewebs-bookbub-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'BookBub', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'quotes':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-quotes-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Quotes', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'arrow-left':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-arrow-left-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Previous', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'arrow-right':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-arrow-right-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Next', 'thewebs' ) ) . '</title>';
				}
			...
			case 'arrow-right-alt':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-arrow-right-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="27" height="28" viewBox="0 0 27 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Continue', 'thewebs' ) ) . '</title>';
				}
				$output .= '<path d="M27 13.953c0 0.141-0.063 0.281-0.156 0.375l-6 5.531c-0.156 0.141-0.359 0.172-0.547 0.094-0.172-0.078-0.297-0.25-0.297-0.453v-3.5h-19.5c-0.281 0-0.5-0.219-0.5-0.5v-3c0-0.281 0.219-0.5 0.5-0.5h19.5v-3.5c0-0.203 0.109-0.375 0.297-0.453s0.391-0.047 0.547 0.078l6 5.469c0.094 0.094 0.156 0.219 0.156 0.359v0z"></path>
				</svg>';
				break;
			case 'arrow-left-alt':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-arrow-left-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="29" height="28" viewBox="0 0 29 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Previous', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'arrow-down':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-arrow-down-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Expand', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'arrow-up':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-arrow-up-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Arrow Up', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'arrow-up2':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-arrow-up2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="26" height="28" viewBox="0 0 26 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Arrow Up', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'chevron-up':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-chevron-up-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Arrow Up', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'chevron-up2':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-chevron-up2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Arrow Up', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'menu':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thewebs-svg-icon thewebs-menu-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'menu2':
				$output .= '<svg class="thewebs-svg-icon thewebs-menu2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'menu3':
				$output .= '<svg class="thewebs-svg-icon thewebs-menu3-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'listFilter':
				$output .= '<svg class="thewebs-svg-icon thewebs-list-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Filter', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'listFilterAlt':
				$output .= '<svg class="thewebs-svg-icon thewebs-list-filter-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Filter', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'close':
				$output .= '<svg class="thewebs-svg-icon thewebs-close-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu Close', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'closeAlt':
				$output .= '<svg class="thewebs-svg-icon thewebs-close-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu Close', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'closeAlt2':
				$output .= '<svg class="thewebs-svg-icon thewebs-close-alt2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu Close', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'shopping-bag':
				$output .= '<svg class="thewebs-svg-icon thewebs-shopping-bag-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 222.77 249.7">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Shopping Cart', 'thewebs' ) ) . '</title>';
				}
				$output .= '<path d="M53.44,69.07c0.28-6.39.22-12.39,0.87-18.3C57.43,21.9,82.41-.09,111.71,0c28.85,0.09,53.69,22.2,56.73,50.67,0.63,5.93.6,11.93,0.89,18.39h4q19.87,0,39.75,0c6.88,0,9.66,2.68,9.67,9.46,0,42.37.14,84.74,0,127.12-0.11,25.27-19,43.93-44.32,44q-66.56.14-133.12,0c-26.43,0-45-18.54-45.19-45-0.1-15.75,0-31.5,0-47.25q0-38.81,0-77.62c0-8.32,2.39-10.68,10.72-10.68H53.44ZM15.38,84.69v4.1c0,38.49.28,77-.13,115.47-0.18,16.81,12.71,30.23,30.15,30,44-.45,88-0.14,132-0.15,18.38,0,30-11.59,30-29.91q0-57.74,0-115.47V84.83H169c0,1.91,0,3.52,0,5.13,0,4.5.12,9-.05,13.5s-3.26,7.7-7.47,7.82c-4.37.12-7.55-3-7.91-7.77-0.11-1.49,0-3,0-4.5,0-4.7,0-9.41,0-14.15H69.19c0,6.31.14,12.3,0,18.29-0.17,5.75-4.65,9.21-9.77,7.85-3.48-.93-5.58-3.92-5.63-8.3-0.07-6,0-11.91,0-18H15.38Zm138-15.81C155.6,43.21,147,29,131.41,20.59c-15.27-8.25-30.69-7.16-44.87,3C71,34.77,67.65,50.83,69.55,68.88h83.8Z"/></path>
				</svg>';
				break;
			case 'shopping-cart':
				$output .= '<svg class="thewebs-svg-icon thewebs-shopping-cart-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 343.78 331.76">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Shopping Cart', 'thewebs' ) ) . '</title>';
				}
				$output .= '<path d="M0,0,42.3.12c7.22,0,9.18,1.5,11.1,8.55q8.22,30.24,16.4,60.5c.29,1.07.61,2.13,1,3.5H333a16.86,16.86,0,0,1,6.8,1.25c3.54,1.59,4.72,5.3,3.52,9.78q-8.94,33.52-18,67Q317.15,181.38,309,212c-4.52,17-16.07,25.84-33.68,25.84H125.56c-3.1,0-6.21-.29-9.77-.47,1.73,6.37,3.41,12.67,5.21,18.93.15.5,1.09,1,1.73,1.08a16.71,16.71,0,0,0,3,.06h151.1a37.39,37.39,0,0,1,37.46,37.34V295a37,37,0,1,1-69.46-18l1.87-3.44H153.21a43,43,0,0,1,6.3,18.34c1.88,19.94-13.52,37.72-34.48,39.61-19.24,1.73-37.7-13.89-39.13-33.13-1.13-15.07,4.61-26.85,17.27-35.07,2.12-1.38,1.74-2.64,1.24-4.44Q85.68,190.55,67,122.14C63.51,109.53,60,97,56.61,84.31,50.82,62.38,45.15,40.42,39.43,18.48c-.2-.74-.49-1.45-.79-2.36H0ZM325.21,89H74.76c.25,1.17.42,2.15.68,3.1q16.08,58.5,32.19,117c2.56,9.31,8,13.43,17.82,13.43H275.19c10.43,0,15.6-4,18.28-14.11q12.33-46.33,24.67-92.65C320.49,106.92,322.81,98.09,325.21,89Zm-48,226.85a21.22,21.22,0,1,0-21.16-21.28v.15a21.16,21.16,0,0,0,21.19,21.12Zm-154.65,0a21.22,21.22,0,1,0-21.19-21.25v.25a21.09,21.09,0,0,0,21.18,21h0Z"></path>
				</svg>';
				break;
			case 'apple_podcasts':
				$output .= '<svg class="thewebs-svg-icon thewebs-apple-podcasts-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Apple Podcasts', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'spotify':
				$output .= '<svg class="thewebs-svg-icon thewebs-spotify-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Spotify', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'flickr':
				$output .= '<svg class="thewebs-svg-icon thewebs-flicker-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Flicker', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case '500px':
				$output .= '<svg class="thewebs-svg-icon thewebs-500px-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( '500PX', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'bandcamp':
				$output .= '<svg class="thewebs-svg-icon thewebs-bandcamp-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Bandcamp', 'thewebs' ) ) . '</title>';
				}
				$output .= '<path d="M0 18.75l7.437-13.5H24l-7.438 13.5H0z" />
				</svg>';
				break;
			case 'imdb':
				$output .= '<svg class="thewebs-svg-icon thewebs-imdb-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'IMDB', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'spinner':
				$output .= '<svg class="thewebs-svg-icon thewebs-spinner-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Loading', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'check':
				$output .= '<svg class="thewebs-svg-icon thewebs-check-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Done', 'thewebs' ) ) . '</title>';
				}
				$output .= '<path d="M14 2.5l-8.5 8.5-3.5-3.5-1.5 1.5 5 5 10-10z"></path>
				</svg>';
				break;
			case 'checkbox':
				$output .= '<svg class="thewebs-svg-icon thewebs-checkbox-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Check Mark', 'thewebs' ) ) . '</title>';
				}
				...
				break;
			case 'checkbox_alt':
				$output .= '<svg class="thewebs-svg-icon thewebs-checkbox-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Check Mark', 'thewebs' ) ) . '</title>';
				}
			...
			case 'shield_check':
				...
				break;
			case 'disc':
				$output .= '<svg class="thewebs-svg-icon thewebs-disc-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Disc', 'thewebs' ) ) . '</title>';
				}
			...
			case 'visa':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Visa Card', 'thewebs' ) ) . '</title>';
				}
			...
			case 'mastercard':
				$output .= '<svg width="100%" height="100%" viewBox="0 0 750 471" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'MasterCard', 'thewebs' ) ) . '</title>';
				}
			...
			case 'amex':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'American Express', 'thewebs' ) ) . '</title>';
				}
			...
			case 'discover':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Discover Card', 'thewebs' ) ) . '</title>';
				}
			...
			case 'paypal':
				$output .= '<svg width="100%" height="100%" viewBox="0 0 780 501" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'PayPal', 'thewebs' ) ) . '</title>';
				}
			...
			case 'applepay':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Apple Pay', 'thewebs' ) ) . '</title>';
				}
			...
			case 'stripe':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Stripe', 'thewebs' ) ) . '</title>';
				}
		...
		$output = apply_filters( 'thewebs_svg_icon', $output, $icon, $icon_title, $base );
