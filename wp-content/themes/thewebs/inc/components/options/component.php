<?php
/**
 * Thewebs\Options\Component class
 *
 * @package thewebs
 */

namespace Thewebs\Options;
 ...
 * * `thewebs()->option()`
 * * `thewebs()->default()`
 * * `thewebs()->get_option_type()`
 * * `thewebs()->get_option_name()`
 * * `thewebs()->sub_option()`
 * * `thewebs()->sidebar_options()`
 * * `thewebs()->palette_option()`
 * * `thewebs()->get_palette()`
 */
class Component implements Component_Interface, Templating_Component_Interface
{
    ...
    public function get_option_type()
    {
        ...
        if (is_null(self::$opt_type)) {
            self::$opt_type = apply_filters('thewebs_theme_option_type', 'theme_mod');
        }
        // Return option_type.
    ...
    public function get_option_name()
    {
        ...
        if (is_null(self::$opt_name)) {
            self::$opt_name = apply_filters('thewebs_theme_option_name', 'thewebs_settings');
        }
        // Return option_name.
    ...
    public static function defaults()
    {
        ...
        if (is_null(self::$default_options)) {
            self::$default_options = apply_filters(
                'thewebs_theme_options_defaults',
                array(
                    'content_width'   => array(
                        'size' => 1240,
                        'unit' => 'px',
                    ...
                    'link_color'                     => array(
                        'highlight'      => 'palette1',
                        'highlight-alt'  => 'palette1',
                        'highlight-alt2' => 'palette1',
                        'style'          => 'standard',
                    ),
                    // Scroll To Top.
                    'scroll_up'               => true,
                    ...
                    'header_popup_layout'         => 'fullwidth',
                    'header_popup_animation'      => 'scale',
                    ...
                    // Header HTML.
                    'header_html_content'    => __('Register now & get an extra 10 off using the code AIkit06 ', 'thewebs'),
                    ...
                    // Header Button.
                    'header_button_label'      => __('Get The App', 'thewebs'),
                    'header_button_link'      => '',
                    ...
                    'mobile_button_label'      => __('Button', 'thewebs'),
                    ...
                    // Mobile Header HTML.
                    'mobile_html_content'    => __('Insert HTML here', 'thewebs'),
                    ...
                    'header_html2_content'    => __( 'Any Help?', 'thewebs-pro' ),
                    ...
                    // Mobile HTML.
                    'header_mobile_html2_content'    => __( 'Insert HTML here', 'thewebs-pro' ),
                    ...
                    'page_title_featured_image' => true,
                    ...
                    'product_archive_image_hover_switch' => 'zoom',
                    ...
                    'product_content_element_extras' => array(
                        ...
                        'feature_4' => '',
                        'feature_5' => '',
                        'feature_1_icon' => 'checkbox',
                        'feature_2_icon' => 'checkbox',
                        'feature_3_icon' => 'checkbox',
                        'feature_4_icon' => 'checkbox',
                        'feature_5_icon' => 'checkbox',
                    ),
                    ...
                    'header_account_label'                   => __('Login', 'thewebs-pro'),
                    ...
                    'header_mobile_account_label'                   => __('Login', 'thewebs-pro'),
                    ...
                    'header_mobile_account_in_label'                   => __('Account', 'thewebs-pro'),
    ...
    {
        $defaults = self::defaults();
        if (! empty($opt_name_key = apply_filters('thewebs_settings_key_custom_mapping', '', $key))) {
    ...
    {
        $palette = get_option('thewebs_global_palette');
    ...
    public static function palette_defaults()
    {
        ...
        if (is_null(self::$default_palette)) {
            self::$default_palette = apply_filters('thewebs_global_palette_defaults', '{"palette":[{"color":"#000000","slug":"palette1","name":"Palette Color 1"},{"color":"#63bbae","slug":"palette2","name":"Palette Color 2"},{"color":"#111111","slug":"palette3","name":"Palette Color 3"},{"color":"#222222","slug":"palette4","name":"Palette Color 4"},{"color":"#000000","slug":"palette5","name":"Palette Color 5"},{"color":"#e5e5e5","slug":"palette6","name":"Palette Color 6"},{"color":"#ffffff","slug":"palette7","name":"Palette Color 7"},{"color":"#ffffff","slug":"palette8","name":"Palette Color 8"},{"color":"#ffffff","slug":"palette9","name":"Palette Color 9"}],
            
            "second-palette":[{"color":"#ffffff","slug":"palette1","name":"Palette Color 1"},{"color":"#63bbae","slug":"palette2","name":"Palette Color 2"},{"color":"#f2f2f2","slug":"palette3","name":"Palette Color 3"},{"color":"#f5f5f5","slug":"palette4","name":"Palette Color 4"},{"color":"#ffffff","slug":"palette5","name":"Palette Color 5"},{"color":"#1c1c1d","slug":"palette6","name":"Palette Color 6"},{"color":"#020203","slug":"palette7","name":"Palette Color 7"},{"color":"#020203","slug":"palette8","name":"Palette Color 8"},{"color":"#ffffff","slug":"palette9","name":"Palette Color 9"}],
    ...
    public function palette_option($subkey, $active_palette = null)
    {
        ...
        $active = ! empty($active_palette) ? $active_palette : apply_filters('thewebs_active_palette', (self::$palette && is_array(self::$palette) && isset(self::$palette['active']) && ! empty(self::$palette['active']) ? self::$palette['active'] : 'palette'));
        $value = '';
        ...
        return apply_filters('thewebs_palette_option', $value, $subkey);
    }
			...
			'content_background' => array(
					'items' => array(
						array(
							...
							'enabled' => true,
							'source'  => 'image',
							'url'     => get_stylesheet_directory_uri(). '/assets/images/phone-solid.svg',
							'imageid' => '',
							'width'   => 16,
							'link'     => '',
							'icon'    => 'phoneAlt2',
