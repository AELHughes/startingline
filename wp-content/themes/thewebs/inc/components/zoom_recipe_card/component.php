<?php
/**
 * Thewebs\Zoom_Recipe_Card\Component class
 *
 * @package thewebs
 */

namespace Thewebs\Zoom_Recipe_Card;
...
class Component implements Component_Interface {
	...
	public function zoom_recipe_card_styles() {
		wp_enqueue_style( 'thewebs-zoom-recipe-card', get_theme_file_uri( '/assets/css/zoom-recipe-card.min.css' ), array(), THEWEBS_VERSION );
	}
}
