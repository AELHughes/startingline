<?php
/**
 * Thewebs\Microdata\Component class
 *
 * @package thewebs
 */

namespace Thewebs\Microdata;
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function print_microdata( string $context ) {
		...
		if ( ! apply_filters( 'thewebs_microdata', true, $context ) ) {
			return;
		}
	...
	public function get_microdata( $context ) {
		...
		if ( 'html' === $context ) {
			...
			$type = apply_filters( 'thewebs_html_itemtype', $type );
		...
		if ( 'article' === $context ) {
			$type = apply_filters( 'thewebs_article_itemtype', 'CreativeWork' );
		...
		if ( $data ) {
			return apply_filters( "thewebs_{$context}_schema", $data );
		}
	}
}
