<?php
/**
 * Thewebs\Heroic_Kb\Component class
 *
 * @package thewebs
 */

namespace Thewebs\Heroic_Kb;
...
class Component implements Component_Interface {
	...
	public function initialize() {
		...
		add_action( 'thewebs_entry_archive_hero', array( $this, 'ht_knowledge_base_breadcrumb_in_title' ), 5 );
		add_action( 'thewebs_entry_archive_header', array( $this, 'ht_knowledge_base_breadcrumb_in_title' ), 5 );
		//add_action( 'thewebs_entry_header', array( $this, 'ht_knowledge_base_breadcrumb_in_title' ), 5 );
		add_action( 'thewebs_entry_archive_hero', array( $this, 'ht_knowledge_base_search_in_title' ), 20 );
		add_action( 'thewebs_entry_archive_header', array( $this, 'ht_knowledge_base_search_in_title' ), 20 );
		add_action( 'thewebs_entry_header', array( $this, 'ht_knowledge_base_search_in_title' ), 20 );
	}
	/**
