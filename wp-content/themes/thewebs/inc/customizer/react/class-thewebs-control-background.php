...
/**
 * Class Thewebs_Control_Background
 *
 * @access public
 */
class Thewebs_Control_Background extends WP_Customize_Media_Control {
	/**
	 * Control type
	 *
	 * @var string
	 */
	public $type = 'thewebs_background_control';
...
$wp_customize->register_control_type( 'Thewebs_Control_Background' );
