...
const GradientTypePicker = ( { gradientAST, hasGradient, onChange } ) => {
	...
	return (
		<SelectControl
			className="components-custom-gradient-picker__type-picker thewebs-select-large"
			label={ __( 'Type' ) }
			labelPosition="top"
...
const GradientPositionPicker = ( { gradientAST, hasGradient, onChange } ) => {
	...
	return (
		<div className={ `components-base-control thewebs-gradient-position-control` }>
				<Flex
					justify="space-between"
					className={ 'thewebs-gradient-position_header' }
				>
					<FlexItem>
						<label className="thewebs-gradient-position__label">{ __( 'Position', 'thewebs-blocks' ) }</label>
					</FlexItem>
				</Flex>
				{ positionType === 'position-keyword' && (
					<div className={ 'thewebs-controls-content' }>
						<SelectControl
							className="components-custom-gradient-picker__position-picker"
							// label={ __( 'Position', 'thewebs-blocks' ) }
							// labelPosition="top"
						...
						/>
						<Button
							className={'thewebs-control-toggle-advanced only-icon'}
							label={ __( 'Set custom position', 'thewebs-blocks' ) }
							icon={ settings }
				...
				{ positionType !== 'position-keyword' && (
					<div className={ 'thewebs-controls-content' }>
						...
						<Button
							className={'thewebs-control-toggle-advanced only-icon'}
							label={ __( 'Set standard position', 'thewebs-blocks' ) }
							icon={ settings }
...
const GradientShapePicker = ( { gradientAST, hasGradient, onChange } ) => {
	...
	return (
		<SelectControl
			className="components-custom-gradient-picker__shape-picker thewebs-select-large"
			label={ __( 'Shape', 'thewebs-blocks' ) }
			labelPosition="top"
			onChange={ onShapeChange }
			options={ [
				{ value: 'ellipse', label: __( 'Ellipse', 'thewebs-blocks'  ) },
				{ value: 'circle', label: __( 'Circle', 'thewebs-blocks'  ) },
			] }
...
export default function CustomGradientPicker( {
	...
	return (
		<div className={ 'components-base-control components-custom-gradient-picker thewebs-gradient-control' }>
