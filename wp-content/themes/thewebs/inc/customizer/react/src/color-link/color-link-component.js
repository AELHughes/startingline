...
class ColorLinkComponent extends Component {
	constructor(props) {
		...
		let defaultParams = {
			colors: {
				'highlight': {
					tooltip: __( 'Initial', 'thewebs' ),
					palette: true,
				},
				'highlight-alt': {
					tooltip: __( 'Hover', 'thewebs' ),
					palette: true,
				},
				'highlight-alt2': {
					tooltip: __( 'Text Alt', 'thewebs' ),
					palette: true,
				},
			},
			styles: {
				'standard': {
					label: __( 'Standard (underline)', 'thewebs' ),
				},
				'color-underline': {
					label: __( 'Highlight Underline', 'thewebs' ),
				},
				'no-underline': {
					label: __( 'No Underline', 'thewebs' ),
				},
				'hover-background': {
					label: __( 'Background on Hover', 'thewebs' ),
				},
				'offset-background': {
					label: __( 'Offset Background', 'thewebs' ),
				},
			},
		};
	...
	render() {
		...
		return (
			<Fragment>
				<div className="thewebs-control-field thewebs-color-control thewebs-link-color-control">
					<span className="customize-control-title">
							{ __( 'Link Style', 'thewebs' ) }
					</span>
					<SelectControl
				...
				<div ref={ this.anchorNodeRef } className="thewebs-control-field thewebs-color-control thewebs-link-color-control">
					{
