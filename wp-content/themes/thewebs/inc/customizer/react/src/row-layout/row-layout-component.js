...
class RowLayoutComponent extends Component {
	constructor() {
		...
		let defaultParams = {
			desktop: {
				'column5': {
					'equal': {
						tooltip: __( 'Equal Width Columns', 'thewebs' ),
						icon: 'fivecol',
					},
				},
				'column4': {
					...
					'left-forty': {
						tooltip: __( 'Left Heavy 40/20/20/20', 'thewebs' ),
						icon: 'lfourforty',
					},
					'right-forty': {
						tooltip: __( 'Right Heavy 20/20/20/40', 'thewebs' ),
						icon: 'rfourforty',
					},
				},
				'column3': {
					...
					'left-half': {
						tooltip: __( 'Left Heavy 50/25/25', 'thewebs' ),
						icon: 'lefthalf',
					},
					'right-half': {
						tooltip: __( 'Right Heavy 25/25/50', 'thewebs' ),
						icon: 'righthalf',
					},
					'center-half': {
						tooltip: __( 'Center Heavy 25/50/25', 'thewebs' ),
						icon: 'centerhalf',
					},
					'center-wide': {
						tooltip: __( 'Wide Center 20/60/20', 'thewebs' ),
						icon: 'widecenter',
					},
				},
				'column2': {
					...
					'left-golden': {
						tooltip: __( 'Left Heavy 66/33', 'thewebs' ),
						icon: 'twoleftgolden',
					},
					'right-golden': {
						tooltip: __( 'Right Heavy 33/66', 'thewebs' ),
						icon: 'tworightgolden',
					},
				},
				'column1': {
			...
			mobile: {
				'column5': {
					...
					'row': {
						tooltip: __( 'Collapse to Rows', 'thewebs' ),
				...
				'column4': {
					...
					'two-grid': {
						tooltip: __( 'Two Column Grid', 'thewebs' ),
						icon: 'grid',
					},
					'row': {
						tooltip: __( 'Collapse to Rows', 'thewebs' ),
				...
				'column3': {
					...
					'first-row': {
						tooltip: __( 'First Row, Next Columns 100 - 50/50', 'thewebs' ),
						icon: 'firstrow',
					},
					'last-row': {
						tooltip: __( 'Last Row, Previous Columns 50/50 - 100', 'thewebs' ),
						icon: 'lastrow',
					},
					'row': {
						tooltip: __( 'Collapse to Rows', 'thewebs' ),
	...
	render() {
		...
		return (
			<div className="thewebs-control-field thewebs-radio-icon-control thewebs-row-layout-control">
											...
											<Tooltip text={ controlMap[ item ].tooltip }>
												...
												>
													...
													{ controlMap[ item ].dashicon && (
														<span className="thewebs-radio-icon thewebs-radio-dashicon">
				...
				{ ! this.controlParams.responsive && (
					<Fragment>
						<div className="thewebs-responsive-control-bar">
	...
	linkColumns() {
		let self = this;
		document.addEventListener( 'thewebsUpdateFooterColumns', function( e ) {
