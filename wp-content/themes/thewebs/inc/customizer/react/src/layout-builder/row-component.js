...
class RowComponent extends Component {
	render() {
		...
		let besideItems = [];
		return (
			<div className={ `thewebs-builder-areas ${ centerClass }` }>
				<Button
					className="thewebs-row-left-actions"
					aria-label={ __( 'Edit Settings for', 'thewebs' ) + ' ' + ( this.props.row === 'popup' ? __( 'Off Canvas', 'thewebs' ) : this.props.row + ' ' + __( 'Row', 'thewebs' ) ) }
					onClick={ () => this.props.focusPanel( mode + '_' + this.props.row ) }
					icon="admin-generic"
				>
				</Button>
				<Button
					className="thewebs-row-actions"
					aria-label={ __( 'Edit Settings for', 'thewebs' ) + ' ' + ( this.props.row === 'popup' ? __( 'Off Canvas', 'thewebs' ) : this.props.row + ' ' + __( 'Row', 'thewebs' ) ) }
					onClick={ () => this.props.focusPanel( mode + '_' + this.props.row ) }
				>
					{ ( this.props.row === 'popup' ? __( 'Off Canvas', 'thewebs' ) : this.props.row + ' ' + __( 'Row', 'thewebs' ) ) }
					<Dashicon icon="admin-generic" />
				</Button>
				<div className="thewebs-builder-group thewebs-builder-group-horizontal" data-setting={ this.props.row }>
