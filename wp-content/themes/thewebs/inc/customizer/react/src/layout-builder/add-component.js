...
class AddComponent extends Component {
	...
	render() {
		...
		let classForAdd = 'thewebs-builder-add-item';
		...
		return (
			<div className={ classForAdd } key={ this.props.id }>
				{ this.state.isVisible && (
					<Popover position="top" className="thewebs-popover-add-builder" onClose={ toggleClose }>
						<div className="thewebs-popover-builder-list">
				...
				<Button
					className="thewebs-builder-item-add-icon"
					onClick={ () => {
