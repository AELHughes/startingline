...
export const ThewebsColorPicker = ({ rgb, hex, hsv, hsl, onChange, renderers }) => {
  const styles = {
	picker: {
		width: 300,
		position: 'relative',
  ...
  return (
    <div style={ styles.picker } className={ 'thewebs-picker' }>
...
export default CustomPicker(ThewebsColorPicker)