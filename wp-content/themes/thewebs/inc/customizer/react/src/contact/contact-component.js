...
class ContactComponent extends Component {
	constructor() {
		...
		let defaultParams = {
			...
			'options': [
				{ value: 'phone', label: __( 'Phone', 'thewebs' ), content: __( '444-546-8765', 'thewebs' ) },
				{ value: 'hours', label: __( 'Hours', 'thewebs' ), content: __( 'Mon - Fri: 8AM - 5PM', 'thewebs' ) },
				{ value: 'email', label: __( 'Email', 'thewebs' ), content: __( 'example@example.com', 'thewebs' ) },
				{ value: 'location', label: __( 'Address', 'thewebs' ), content: __( '4560 example street', 'thewebs' ) },
			],
		};
		...
		return (
			<div className="thewebs-control-field thewebs-sorter-items">
				...
				{ undefined !== availibleContactOptions[0] && undefined !== availibleContactOptions[0].value && (
					<div className="thewebs-contact-add-area thewebs-social-add-area">
						{ this.state.isVisible && (
							<Popover position="top right" className="thewebs-popover-color thewebs-popover-contact thewebs-customizer-popover" onClose={ toggleClose }>
								<div className="thewebs-popover-contact-list thewebs-popover-social-list">
