			...
			<div className="thewebs-sorter-item" data-id={ this.props.item.id } key={ this.props.item.id }>
				<div className="thewebs-sorter-item-panel-header">
					...
					<span className="thewebs-sorter-title">
						{ ( undefined !== this.props.item.label && '' !== this.props.item.label ? this.props.item.label : __( 'Contact Item', 'thewebs' ) ) }
					</span>
				...
				{ this.state.open && (
					<div className="thewebs-sorter-item-panel-content">
						<TabPanel className="sortable-style-tabs thewebs-contact-type"
												...
												<Fragment>
													...
													{ this.props.item.url && (
														<div className="contact-custom-image">
															<div className="thewebs-Contact-image">
																<img className="thewebs-Contact-image-preview" src={ this.props.item.url } />
															</div>
															<Button
