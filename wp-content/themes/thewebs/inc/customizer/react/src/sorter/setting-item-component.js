...
class ItemComponent extends Component {
	...
	render() {
		...
		if ( taxOptions ) {
			taxOptions = [{ label: __( 'Select', 'thewebs' ), value: '' }].concat( taxOptions );
		}
		return (
			<div className="thewebs-sorter-item" data-id={ this.props.item } key={ this.props.item }>
				<div className={ `thewebs-sorter-item-panel-header ${ ( this.state.item.enabled ? 'panel-item-is-visible' : 'panel-item-is-hidden' ) }` }>
					{ this.props.moveable && ( 
						<span
					...
					<Tooltip text={ __( 'Toggle Item Visibility', 'thewebs' ) }>
						<Button
							className={ `thewebs-sorter-visiblity ${ ( this.state.item.enabled ? 'item-is-visible' : 'item-is-hidden' ) }`}
							onClick={ () => {
					...
					<span className="thewebs-sorter-title">
					...
					{ 'title' !== this.props.item && 'above_title' !== this.props.item && 'back_link' !== this.props.item && 'category' !== this.props.item && 'description' !== this.props.item && 'rating' !== this.props.item && 'product_meta' !== this.props.item && 'share' !== this.props.item && (
						<Tooltip text={ __( 'Expand Item Controls', 'thewebs' ) }>
							<Button
								className="thewebs-sorter-item-expand"
								onClick={ () => {
				...
				{ this.state.open && (
					<div className="thewebs-sorter-item-panel-content">
						{ undefined !== this.state.item.ratio && (
							<div class="components-base-control">
								<span className="sorter-control-title">{ __( 'Set Image Ratio', 'thewebs' ) }</span>
								<ButtonGroup className="thewebs-radio-container-control thewebs-featured-image-ratio">
											...
											<Fragment>
												...
												>
													{ this.props.controlParams.ratios[ item ].icon && (
														<span className="thewebs-radio-icon">
						...
						{ undefined !== this.state.item.imageLink && (
							<div className="components-base-control">
								<ToggleControl
									label={ __( 'Image is link to post', 'thewebs' ) }
						...
						{ undefined !== this.state.item.show_title && (
							<div className="components-base-control">
								<ToggleControl
									label={ __( 'Show Post Title in Breadcrumb?', 'thewebs' ) }
						...
						{ undefined !== this.state.item.fullContent && (
							<div className="components-base-control">
								<ToggleControl
									label={ __( 'Show Full Content?', 'thewebs' ) }
								...
								{ undefined !== this.state.item.words && false === this.state.item.fullContent && (
									<RangeControl
										...
										max={ 125 }
										step={ 1 }
										label={ __( 'Excerpt Word Count', 'thewebs' ) }
									/>
								) }
							</div>
						) }
						{ undefined !== this.state.item.size && (
							<div class="components-base-control">
								<span className="sorter-control-title">{ __( 'Set Image Size', 'thewebs' ) }</span>
								<SelectControl
						...
						{ undefined !== this.state.item.divider && (
							<div class="components-base-control">
								<span className="sorter-control-title">{ __( 'Choose a Divider', 'thewebs' ) }</span>
								<ButtonGroup className="thewebs-radio-container-control">
						...
						{ undefined !== this.state.item.button_size && (
							<div class="components-base-control">
								<span className="sorter-control-title">{ __( 'Choose Button Size', 'thewebs' ) }</span>
								<ButtonGroup className="thewebs-radio-container-control">
						...
						{ undefined !== this.state.item.style && (
							<div class="components-base-control">
								<span className="sorter-control-title">{ __( 'Choose a Style', 'thewebs' ) }</span>
								<ButtonGroup className="thewebs-radio-container-control">
						...
						{ undefined !== this.state.item.taxonomy && (
							<div class="components-base-control">
								<span className="sorter-control-title">{ __( 'Choose a Taxonomy', 'thewebs' ) }</span>
								<SelectControl
						...
						{ undefined !== this.state.item.show_shipping && (
							<div className="components-base-control">
								<ToggleControl
									label={ __( 'Show Shipping Statement?', 'thewebs' ) }
									...
									<Fragment>
										{ undefined !== this.state.item.shipping_statement && (
											<div className="meta-label-control">
												<span className="sorter-control-title">{ __( 'Shipping Excerpt', 'thewebs' ) }</span>
						...
						{ undefined !== this.state.item.feature_1 && (
							<div className="sorter-sub-option">
								<TextControl
									label={ __( 'First Feature', 'thewebs' ) }
									value={ this.state.item.feature_1 }
									onChange={ ( value ) => {
										this.updateValues( { feature_1: value } );
									} }
								/>
								<span className="sorter-control-title">{ __( 'Choose a Icon', 'thewebs' ) }</span>
								<ButtonGroup className="thewebs-radio-container-control">
						...
						{ undefined !== this.state.item.feature_2 && (
							<div className="sorter-sub-option">
								<TextControl
									label={ __( 'Second Feature', 'thewebs' ) }
						...
						{ undefined !== this.state.item.feature_3 && (
							<div className="sorter-sub-option">
								<TextControl
									label={ __( 'Third Feature', 'thewebs' ) }
						...
						{ undefined !== this.state.item.feature_4 && (
							<div className="sorter-sub-option">
								<TextControl
									label={ __( 'Fourth Feature', 'thewebs' ) }
						...
						{ undefined !== this.state.item.feature_5 && (
							<div className="sorter-sub-option">
								<TextControl
									label={ __( 'Fifth Feature', 'thewebs' ) }
								...
								{ this.state.item.author && (
									<Fragment>
										{ undefined !== this.state.item.authorLink && (
											<Fragment>
												<ToggleControl
													label={ __( 'Enable Author Link?', 'thewebs' ) }
										...
										{ undefined !== this.state.item.authorImage && (
											<Fragment>
												<ToggleControl
													label={ __( 'Show Author Image?', 'thewebs' ) }
												...
												{ undefined !== this.state.item.authorImageSize && true === this.state.item.authorImage && (
													<RangeControl
														...
														max={ 125 }
														step={ 1 }
														label={ __( 'Author Image Size (px)', 'thewebs' ) }
													/>
												) }
											</Fragment>
										) }
										{ undefined !== this.state.item.authorLabel && (
											<div className="meta-label-control">
												<span className="sorter-control-title">{ __( 'Author Label', 'thewebs' ) }</span>
												<div className={ `meta-label-input-control ${ ( this.state.item.authorEnableLabel ? 'label-is-visible' : 'label-is-hidden' ) }` }>
													<Tooltip text={ __( 'Toggle Label Visibility', 'thewebs' ) }>
														<Button
															className={ `thewebs-label-visiblity ${ ( this.state.item.authorEnableLabel ? 'item-is-visible' : 'item-is-hidden' ) }`}
															onClick={ () => {
						...
						{ undefined !== this.state.item.date && (
							<div className="sorter-sub-option">
								...
								{ undefined !== this.state.item.dateLabel && this.state.item.date && (
									<div className="meta-label-control">
										<span className="sorter-control-title">{ __( 'Date Label', 'thewebs' ) }</span>
										<div className={ `meta-label-input-control ${ ( this.state.item.dateEnableLabel ? 'label-is-visible' : 'label-is-hidden' ) }` }>
											<Tooltip text={ __( 'Toggle Label Visibility', 'thewebs' ) }>
												<Button
													className={ `thewebs-label-visiblity ${ ( this.state.item.dateEnableLabel ? 'item-is-visible' : 'item-is-hidden' ) }`}
													onClick={ () => {
											...
											<TextControl
												label=""
												placeholder={ __( 'Posted on', 'thewebs' ) }
						...
						{ undefined !== this.state.item.dateUpdated && (
							<div className="sorter-sub-option">
								<ToggleControl
									label={ __(  'Show Last Updated Date?', 'thewebs' ) }
								...
								{ this.state.item.dateUpdated && (
									<ToggleControl
										label={ __( 'Show only if different from publish date?', 'thewebs' ) }
								...
								{ undefined !== this.state.item.dateUpdatedLabel && this.state.item.dateUpdated && (
									<div className="meta-label-control">
										<span className="sorter-control-title">{ __( 'Updated Date Label', 'thewebs' ) }</span>
										<div className={ `meta-label-input-control ${ ( this.state.item.dateUpdatedEnableLabel ? 'label-is-visible' : 'label-is-hidden' ) }` }>
											<Tooltip text={ __( 'Toggle Label Visibility', 'thewebs' ) }>
												<Button
													className={ `thewebs-label-visiblity ${ ( this.state.item.dateUpdatedEnableLabel ? 'item-is-visible' : 'item-is-hidden' ) }`}
													onClick={ () => {
											...
											<TextControl
												label=""
												placeholder={ __( 'Updated on', 'thewebs' ) }
						...
						{ undefined !== this.state.item.categories && (
							<div className="sorter-sub-option">
								<ToggleControl
									label={ __( 'Show Categories?', 'thewebs' ) }
								...
								{ undefined !== this.state.item.categoriesLabel && this.state.item.categories && this.state.item.metaLabel && (
									<div className="meta-label-control">
										<span className="sorter-control-title">{ __( 'Categories Label', 'thewebs' ) }</span>
										<div className={ `meta-label-input-control ${ ( this.state.item.categoriesEnableLabel ? 'label-is-visible' : 'label-is-hidden' ) }` }>
											<Tooltip text={ __( 'Toggle Label Visibility', 'thewebs' ) }>
												<Button
													className={ `thewebs-label-visiblity ${ ( this.state.item.categoriesEnableLabel ? 'item-is-visible' : 'item-is-hidden' ) }`}
													onClick={ () => {
											...
											<TextControl
												label=""
												placeholder={ __( 'Posted in', 'thewebs' ) }
						...
						{ undefined !== this.state.item.comments && (
							<div className="sorter-sub-option">
								<ToggleControl
									label={ __(  'Show Comments?', 'thewebs' ) }
								...
								{ this.state.item.comments && (
									<ToggleControl
										label={ __( 'Show only if post has at least one comment', 'thewebs' ) }
						...
						{ undefined !== this.state.item.card_color && (
							<div class="components-base-control">
								<span className="sorter-control-title">{ __( 'Choose Icon Colors', 'thewebs' ) }</span>
								<ButtonGroup className="thewebs-radio-container-control">
						...
						{ undefined !== this.state.item.mastercard && (
							<ToggleControl
								label={ __(  'Show Mastercard?', 'thewebs' ) }
						...
						{ undefined !== this.state.item.discover && (
							<ToggleControl
								label={ __(  'Show Discover?', 'thewebs' ) }
						...
						{ undefined !== this.state.item.applepay && (
							<ToggleControl
								label={ __(  'Show Apple Pay?', 'thewebs' ) }
						...
						{ undefined !== this.state.item.custom_enable_01 && (
							<Fragment>
								<ToggleControl
									label={ __(  'Show Custom 01?', 'thewebs' ) }
									...
									<Fragment>
										...
										{ this.state.item.custom_img_01 && (
											<div className="social-custom-image">
												<div className="thewebs-social-image">
													<img className="thewebs-social-image-preview" src={ this.state.item.custom_img_01 } />
												</div>
												<Button
						...
						{ undefined !== this.state.item.custom_enable_02 && (
							<Fragment>
								<ToggleControl
									label={ __(  'Show Custom 02?', 'thewebs' ) }
								...
								{ this.state.item.custom_enable_02 && (
									<Fragment>
										...
										{ this.state.item.custom_img_02 && (
											<div className="social-custom-image">
												<div className="thewebs-social-image">
													<img className="thewebs-social-image-preview" src={ this.state.item.custom_img_02 } />
												</div>
												<Button
													className='remove-image'
													isDestructive
						...
						{ undefined !== this.state.item.custom_enable_03 && (
							<Fragment>
								<ToggleControl
									label={ __(  'Show Custom 03?', 'thewebs' ) }
								...
								{ this.state.item.custom_enable_03 && (
									<Fragment>
										...
										{ this.state.item.custom_img_03 && (
											<div className="social-custom-image">
												<div className="thewebs-social-image">
													<img className="thewebs-social-image-preview" src={ this.state.item.custom_img_03 } />
												</div>
												<Button
													className='remove-image'
													isDestructive
						...
						{ undefined !== this.state.item.custom_enable_04 && (
							<Fragment>
								<ToggleControl
									label={ __(  'Show Custom 04?', 'thewebs' ) }
								...
								{ this.state.item.custom_enable_04 && (
									<Fragment>
										...
										{ this.state.item.custom_img_04 && (
											<div className="social-custom-image">
												<div className="thewebs-social-image">
													<img className="thewebs-social-image-preview" src={ this.state.item.custom_img_04 } />
												</div>
												<Button
													className='remove-image'
													isDestructive
						...
						{ undefined !== this.state.item.custom_enable_05 && (
							<Fragment>
								<ToggleControl
									label={ __(  'Show Custom 05?', 'thewebs' ) }
								...
								{ this.state.item.custom_enable_05 && (
									<Fragment>
										...
										{ this.state.item.custom_img_05 && (
											<div className="social-custom-image">
												<div className="thewebs-social-image">
													<img className="thewebs-social-image-preview" src={ this.state.item.custom_img_05 } />
												</div>
												<Button
													className='remove-image'
													isDestructive
