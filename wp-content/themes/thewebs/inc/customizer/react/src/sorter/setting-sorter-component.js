...
class SorterComponent extends Component {
	constructor() {
		...
		let defaultParams = {
			...
			imageSizes: {
				thumbnail: {
					name: __( 'Thumbnail', 'thewebs' ),
				},
				medium: {
					name: __( 'Medium', 'thewebs' ),
				},
				medium_large: {
					name: __( 'Medium Large', 'thewebs' ),
				},
				large: {
					name: __( 'Large', 'thewebs' ),
				},
				full: {
					name: __( 'Full', 'thewebs' ),
				},
			},
			ratios: {
				'inherit': {
	...
	render() {
		const controlLabel = (
			<Fragment>
				{/* <Tooltip text={ __( 'Reset Value', 'thewebs' ) }>
					<Button
		...
		return (
			<div className="thewebs-control-field thewebs-sorter-items thewebs-post-title-sorter">
				...
				<div className="thewebs-sorter-row">
					...
					{ ! this.controlParams.sortable && (
						<div className={ `thewebs-sorter-drop thewebs-sorter-sortable-panel thewebs-sorter-no-sorting thewebs-sorter-drop-${ this.controlParams.group }` } >
							{ currentList.map( ( item, index ) => {
								return <ItemComponent
									key={ item }
									item={ item }
