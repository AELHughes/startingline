...
class MeasureComponent extends Component {
	...
	render() {
		...
		return (
			<div className="thewebs-control-field thewebs-range-control">
				{ this.controlParams.responsive && (
					<ResponsiveControl
					...
					>
						...
						<div className="thewebs-units thewebs-locked">
							{ this.getResponsiveLockedButtons() }
						</div>
						{ this.controlParams.units && (
							<div className="thewebs-units">
				...
				{ ! this.controlParams.responsive && (
					<Fragment>
						...
						<div className="thewebs-responsive-controls-content">
							{ this.state.locked && (
								<RangeControl
