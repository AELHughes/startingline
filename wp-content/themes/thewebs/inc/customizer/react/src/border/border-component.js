...
class BorderComponent extends Component {
	...
	render() {
		...
		return (
			<div ref={ this.anchorNodeRef } className="thewebs-control-field thewebs-border-control">
				{ this.controlParams.responsive && (
					...
					>
						...
						{ this.controlParams.styles && (
							<div className="thewebs-units thewebs-style-options">
