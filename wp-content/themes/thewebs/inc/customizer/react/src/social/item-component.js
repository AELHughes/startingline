	...
	render() {
		...
		return (
			<div className="thewebs-sorter-item" data-id={ this.props.item.id } key={ this.props.item.id }>
				<div className="thewebs-sorter-item-panel-header">
					...
					<span className="thewebs-sorter-title">
						{ ( undefined !== this.props.item.label && '' !== this.props.item.label ? this.props.item.label : __( 'Social Item', 'thewebs' ) ) }
					</span>
				...
				{ this.state.open && (
					<div className="thewebs-sorter-item-panel-content">
						<TabPanel className="sortable-style-tabs thewebs-social-type"
													...
													{ this.props.item.url && (
														<div className="social-custom-image">
															<div className="thewebs-social-image">
																<img className="thewebs-social-image-preview" src={ this.props.item.url } />
															</div>
															<Button
						...
						/>
						<Button
							className="thewebs-sorter-item-remove"
							isDestructive
							onClick={ () => {
								this.props.removeItem( this.props.index );
							} }
						>
							{ __( 'Remove Item', 'thewebs' ) }
