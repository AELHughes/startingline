...
class SocialComponent extends Component {
	constructor() {
		...
		let defaultParams = {
			...
			'options': [
				{ value: 'facebook', label: __( 'Facebook', 'thewebs' ) },
				{ value: 'twitter', label: __( 'Twitter', 'thewebs' ) },
				{ value: 'instagram', label: __( 'Instagram', 'thewebs' ) },
				{ value: 'youtube', label: __( 'YouTube', 'thewebs' ) },
				{ value: 'facebook_group', label: __( 'Facebook Group', 'thewebs' ) },
				{ value: 'vimeo', label: __( 'Vimeo', 'thewebs' ) },
				{ value: 'pinterest', label: __( 'Pinterest', 'thewebs' ) },
				{ value: 'linkedin', label: __( 'Linkedin', 'thewebs' ) },
				{ value: 'medium', label: __( 'Medium', 'thewebs' ) },
				{ value: 'wordpress', label: __( 'WordPress', 'thewebs' ) },
				{ value: 'reddit', label: __( 'Reddit', 'thewebs' ) },
				{ value: 'patreon', label: __( 'Patreon', 'thewebs' ) },
				{ value: 'github', label: __( 'GitHub', 'thewebs' ) },
				{ value: 'dribbble', label: __( 'Dribbble', 'thewebs' ) },
				{ value: 'behance', label: __( 'Behance', 'thewebs' ) },
				{ value: 'vk', label: __( 'VK', 'thewebs' ) },
				{ value: 'xing', label: __( 'Xing', 'thewebs' ) },
				{ value: 'rss', label: __( 'RSS', 'thewebs' ) },
				{ value: 'email', label: __( 'Email', 'thewebs' ) },
				{ value: 'phone', label: __( 'Phone', 'thewebs' ) },
				{ value: 'whatsapp', label: __( 'WhatsApp', 'thewebs' ) },
				{ value: 'google_reviews', label: __( 'Google Reviews', 'thewebs' ) },
				{ value: 'telegram', label: __( 'Telegram', 'thewebs' ) },
				{ value: 'yelp', label: __( 'Yelp', 'thewebs' ) },
				{ value: 'trip_advisor', label: __( 'Trip Advisor', 'thewebs' ) },
				{ value: 'imdb', label: __( 'IMDB', 'thewebs' ) },
				{ value: 'soundcloud', label: __( 'SoundCloud', 'thewebs' ) },
				{ value: 'tumblr', label: __( 'Tumblr', 'thewebs' ) },
				{ value: 'discord', label: __( 'Discord', 'thewebs' ) },
				{ value: 'tiktok', label: __( 'TikTok', 'thewebs' ) },
				{ value: 'spotify', label: __( 'Spotify', 'thewebs' ) },
				{ value: 'apple_podcasts', label: __( 'Apple Podcast', 'thewebs' ) },
				{ value: 'flickr', label: __( 'Flickr', 'thewebs' ) },
				{ value: '500px', label: __( '500PX', 'thewebs' ) },
				{ value: 'bandcamp', label: __( 'Bandcamp', 'thewebs' ) },
				{ value: 'anchor', label: __( 'Anchor', 'thewebs' ) },
				{ value: 'custom1', label: __( 'Custom 1', 'thewebs' ) },
				{ value: 'custom2', label: __( 'Custom 2', 'thewebs' ) },
				{ value: 'custom3', label: __( 'Custom 3', 'thewebs' ) },
			],
		};
	...
	onDragStart() {
		var dropzones = document.querySelectorAll( '.thewebs-builder-area' );
		var i;
		for (i = 0; i < dropzones.length; ++i) {
			dropzones[i].classList.add( 'thewebs-dragging-dropzones' );
		}
	}
	onDragStop() {
		var dropzones = document.querySelectorAll( '.thewebs-builder-area' );
		var i;
		for (i = 0; i < dropzones.length; ++i) {
			dropzones[i].classList.remove( 'thewebs-dragging-dropzones' );
		}
	}
	...
	render() {
		...
		return (
			<div className="thewebs-control-field thewebs-sorter-items">
				<div className="thewebs-sorter-row">
					<ReactSortable animation={100} onStart={ () => this.onDragStop() } onEnd={ () => this.onDragStop() } group={ this.controlParams.group } className={ `thewebs-sorter-drop thewebs-sorter-sortable-panel thewebs-sorter-drop-${ this.controlParams.group }` } handle={ '.thewebs-sorter-item-panel-header' } list={ theItems } setList={ ( newState ) => this.onDragEnd( newState ) } >
						{ currentList.length > 0 && (
				...
				{ undefined !== availableSocialOptions[0] && undefined !== availableSocialOptions[0].value && (
					<div className="thewebs-social-add-area">
						{/* <SelectControl
						...
						{ this.state.isVisible && (
							<Popover position="top right" className="thewebs-popover-color thewebs-popover-social thewebs-customizer-popover" onClose={ toggleClose }>
								<div className="thewebs-popover-social-list">
						...
						<Button
							className="thewebs-sorter-add-item"
							isPrimary
							onClick={ () => {
								this.setState( { isVisible: true } );
							} }
						>
							{ __( 'Add Social', 'thewebs' ) }
							<Dashicon icon="plus"/>
						</Button>
						{/* <Button
							className="thewebs-sorter-add-item"
