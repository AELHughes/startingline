...
$settings = array(
	...
	'logo_width' => array(
		...
		'default'      => thewebs()->default( 'logo_width' ),
		'input_attrs'  => array(
			'min'     => array(
				'px'  => 10,
				'em'  => 1,
	...
	'info_transparent_logo_in_use' => array(
		...
		'section'      => 'title_tagline',
		'priority'     => 5,
		'description'        => esc_html__( '*NOTICE Custom transparent logo will show on pages that have the transparent header enabled. Change that in your transparent header settings.', 'thewebs' ),
		'settings'     => false,
		'context'      => array(
			array(
				'setting' => '__current_tab',
	...
	'logo_layout' => array(
		'control_type' => 'thewebs_multi_radio_icon_control',
		'section'      => 'title_tagline',
		'priority'     => 6,
		'default'      => thewebs()->default( 'logo_layout' ),
		'label'        => esc_html__( 'Logo Layout', 'thewebs' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
	...
	'brand_typography' => array(
		...
		'section'      => 'title_tagline',
		'label'        => esc_html__( 'Site Title Font', 'thewebs' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
		...
		'default'      => thewebs()->default( 'brand_typography' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
				'selector' => array(
	...
	'brand_typography_color' => array(
		...
		'section'      => 'title_tagline',
		'label'        => esc_html__( 'Site Title Hover and Active Colors', 'thewebs' ),
		'default'      => thewebs()->default( 'brand_typography_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'brand_tag_typography' => array(
		'control_type' => 'thewebs_typography_control',
		'section'      => 'title_tagline',
		'label'        => esc_html__( 'Site Tagline Font', 'thewebs' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
		...
		'default'      => thewebs()->default( 'brand_tag_typography' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
				'selector' => array(
	...
	'header_logo_padding' => array(
		...
		'section'      => 'title_tagline',
		'priority'     => 15,
		'default'      => thewebs()->default( 'header_logo_padding' ),
	...
	'logo_link_to_site_icon' => array(
		...
		'settings'     => false,
		'priority'     => 25,
		'label'        => esc_html__( 'Site Icon', 'thewebs' ),
		'input_attrs'  => array(
			'section' => 'thewebs_customizer_site_identity',
		),
	),
	'site_logo_link' => array(
		...
		'settings'     => false,
		'priority'     => 5,
		'label'        => esc_html__( 'Site Title and Logo Control', 'thewebs' ),
		'input_attrs'  => array(
			'section' => 'title_tagline',
		),
	),
	'post_archive_home_title' => array(
		...
		'transport'    => 'refresh',
		'default'      => thewebs()->default( 'post_archive_home_title' ),
		'label'        => esc_html__( 'Show site name for page title', 'thewebs' ),
		'context'      => array(
			array(
