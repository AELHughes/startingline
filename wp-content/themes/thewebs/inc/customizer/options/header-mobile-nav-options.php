...
$settings = array(
	...
	'mobile_navigation_color' => array(
		...
		'default'      => thewebs()->default( 'mobile_navigation_color' ),
		'live_method'  => array(
			array(
				'type'     => 'css',
	...
	'mobile_navigation_background' => array(
		...
		'section'      => 'mobile_navigation',
		'priority'     => 20,
		'label'        => esc_html__( 'Background', 'thewebs' ),
		'default'      => thewebs()->default( 'mobile_navigation_background' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.mobile-navigation ul li:not(.menu-item-has-children) > a, .mobile-navigation ul li.menu-item-has-children > .drawer-nav-drop-wrap',
	...
	'mobile_navigation_divider' => array(
		...
		'default'      => thewebs()->default( 'mobile_navigation_divider' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'mobile_navigation_typography' => array(
		...
		'default'      => thewebs()->default( 'mobile_navigation_typography' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
	...
	'mobile_navigation_vertical_spacing' => array(
		...
		'section'      => 'mobile_navigation',
		'priority'     => 20,
		'label'        => esc_html__( 'Items Vertical Spacing', 'thewebs' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
		...
		'default'      => thewebs()->default( 'mobile_navigation_vertical_spacing' ),
		'input_attrs'  => array(
			'min'        => array(
				'px'  => 0,
				'em'  => 0,
	...
	'mobile_navigation_collapse' => array(
		...
		'section'      => 'mobile_navigation',
		'priority'     => 20,
		'default'      => thewebs()->default( 'mobile_navigation_collapse' ),
		'label'        => esc_html__( 'Collapse sub menu items?', 'thewebs' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
		...
		'partial'      => array(
			...
			'render_callback'     => 'Thewebs\mobile_navigation',
		),
	),
	'mobile_navigation_parent_toggle' => array(
		...
		'section'      => 'mobile_navigation',
		'priority'     => 20,
		'default'      => thewebs()->default( 'mobile_navigation_parent_toggle' ),
		'label'        => esc_html__( 'Entire parent menu item expands sub menu', 'thewebs' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
