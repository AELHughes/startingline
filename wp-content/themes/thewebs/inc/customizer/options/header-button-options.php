...
Theme_Customizer::add_settings(
	array(
		...
		'header_button_label' => array(
			...
			'default'      => thewebs()->default( 'header_button_label' ),
			'live_method'     => array(
				array(
					'type'     => 'html',
		...
		'header_button_link' => array(
			...
			'priority'     => 4,
			'default'      => thewebs()->default( 'header_button_link' ),
			'partial'      => array(
				'selector'            => '.header-button-wrap',
				'container_inclusive' => true,
				'render_callback'     => 'Thewebs\header_button',
			),
		),
		'header_button_target' => array(
			...
			'section'      => 'header_button',
			'priority'     => 6,
			'default'      => thewebs()->default( 'header_button_target' ),
		...
		'header_button_nofollow' => array(
			...
			'section'      => 'header_button',
			'priority'     => 6,
			'default'      => thewebs()->default( 'header_button_nofollow' ),
		...
		'header_button_sponsored' => array(
			...
			'section'      => 'header_button',
			'priority'     => 6,
			'default'      => thewebs()->default( 'header_button_sponsored' ),
		...
		'header_button_download' => array(
			...
			'section'      => 'header_button',
			'priority'     => 6,
			'default'      => thewebs()->default( 'header_button_download' ),
			'label'        => esc_html__( 'Set link to Download?', 'thewebs' ),
		),
		'header_button_style' => array(
			'control_type' => 'thewebs_radio_icon_control',
			'section'      => 'header_button',
			'priority'     => 6,
			'default'      => thewebs()->default( 'header_button_style' ),
		...
		'header_button_visibility' => array(
			...
			'section'      => 'header_button',
			'priority'     => 6,
			'default'      => thewebs()->default( 'header_button_visibility' ),
		...
		'header_button_size' => array(
			...
			'section'      => 'header_button_design',
			'priority'     => 4,
			'default'      => thewebs()->default( 'header_button_size' ),
		...
		'header_button_padding' => array(
			...
			'section'      => 'header_button_design',
			'priority'     => 10,
			'default'      => thewebs()->default( 'header_button_padding' ),
			'label'        => esc_html__( 'Padding', 'thewebs' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
		...
		'header_button_color' => array(
			...
			'default'      => thewebs()->default( 'header_button_color' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '#main-header .header-button',
		...
		'header_button_background' => array(
			...
			'default'      => thewebs()->default( 'header_button_background' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '#main-header .header-button',
		...
		'header_button_border_colors' => array(
			...
			'default'      => thewebs()->default( 'header_button_border' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
		...
		'header_button_radius' => array(
			...
			'section'      => 'header_button_design',
			'priority'     => 10,
			'default'      => thewebs()->default( 'header_button_radius' ),
		...
		'header_button_typography' => array(
			...
			'default'      => thewebs()->default( 'header_button_typography' ),
			'live_method'     => array(
				array(
					'type'     => 'css_typography',
					'selector' => '#main-header .header-button',
		...
		'header_button_shadow' => array(
			...
			'default'      => thewebs()->default( 'header_button_shadow' ),
		),
		'header_button_shadow_hover' => array(
			...
			'default'      => thewebs()->default( 'header_button_shadow_hover' ),
		),
		'header_button_margin' => array(
			'control_type' => 'thewebs_measure_control',
			'section'      => 'header_button_design',
			'priority'     => 10,
			'default'      => thewebs()->default( 'header_button_margin' ),
