...
$settings = array(
	...
	'header_mobile_cart_label' => array(
		...
		'priority'     => 6,
		'default'      => thewebs()->default( 'header_mobile_cart_label' ),
	...
	'header_mobile_cart_icon' => array(
		...
		'section'      => 'mobile_cart',
		'priority'     => 10,
		'default'      => thewebs()->default( 'header_mobile_cart_icon' ),
		'label'        => esc_html__( 'Cart Icon', 'thewebs' ),
		'partial'      => array(
			'selector'            => '.header-mobile-cart-wrap',
			'container_inclusive' => true,
			'render_callback'     => 'Thewebs\mobile_cart',
		),
		'input_attrs'  => array(
			'layout' => array(
				'shopping-bag' => array(
	...
	'header_mobile_cart_style' => array(
		...
		'section'      => 'mobile_cart',
		'priority'     => 10,
		'default'      => thewebs()->default( 'header_mobile_cart_style' ),
	...
	'header_mobile_cart_show_total' => array(
		...
		'default'      => thewebs()->default( 'header_mobile_cart_show_total' ),
	...
	'header_mobile_cart_icon_size' => array(
		...
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.header-mobile-cart-wrap .header-cart-button .thewebs-svg-iconset',
				'property' => 'font-size',
				'pattern'  => '$',
				'key'      => 'size',
			),
		),
		'default'      => thewebs()->default( 'header_mobile_cart_icon_size' ),
		'input_attrs'  => array(
			'min'        => array(
				'px'  => 0,
				'em'  => 0,
	...
	'header_mobile_cart_color' => array(
		...
		'default'      => thewebs()->default( 'header_mobile_cart_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'header_mobile_cart_background' => array(
		...
		'default'      => thewebs()->default( 'header_mobile_cart_background' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.header-mobile-cart-wrap .header-cart-inner-wrap .header-cart-button',
	...
	'header_mobile_cart_total_color' => array(
		...
		'default'      => thewebs()->default( 'header_mobile_cart_total_color' ),
		'context'      => array(
			array(
	...
	'header_mobile_cart_total_background' => array(
		...
		'default'      => thewebs()->default( 'header_mobile_cart_total_background' ),
		'context'      => array(
			array(
				'setting'  => 'header_mobile_cart_show_total',
				'operator' => '=',
	...
	'header_mobile_cart_typography' => array(
		...
		'default'      => thewebs()->default( 'header_mobile_cart_typography' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
	...
	'header_mobile_cart_padding' => array(
		...
		'section'      => 'mobile_cart_design',
		'priority'     => 10,
		'default'      => thewebs()->default( 'header_mobile_cart_padding' ),
	...
	'header_mobile_cart_popup_side' => array(
		...
		'section'      => 'mobile_cart',
		'priority'     => 20,
		'default'      => thewebs()->default( 'header_mobile_cart_popup_side' ),
