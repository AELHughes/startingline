...
$settings = array(
	...
	'footer_middle_contain' => array(
		...
		'section'      => 'footer_middle',
		'priority'     => 4,
		'default'      => thewebs()->default( 'footer_middle_contain' ),
	...
	'footer_middle_columns' => array(
		...
		'priority'     => 5,
		//'transport'    => 'refresh',
		'default'      => thewebs()->default( 'footer_middle_columns' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
	...
	'footer_middle_layout' => array(
		...
		'priority'     => 5,
		//'transport'    => 'refresh',
		'default'      => thewebs()->default( 'footer_middle_layout' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
	...
	'footer_middle_collapse' => array(
		...
		'section'      => 'footer_middle',
		'priority'     => 5,
		'default'      => thewebs()->default( 'footer_middle_collapse' ),
	...
	'footer_middle_direction' => array(
		...
		'section'      => 'footer_middle',
		'priority'     => 5,
		'default'      => thewebs()->default( 'footer_middle_direction' ),
	...
	'footer_middle_column_spacing' => array(
		...
		'default'      => thewebs()->default( 'footer_middle_column_spacing' ),
		'input_attrs'  => array(
			'min'     => array(
				'px'  => 0,
				'em'  => 0,
	...
	'footer_middle_widget_spacing' => array(
		...
		'live_method'     => array(
			array(
				...
				'selector' => '.site-middle-footer-inner-wrap .widget, .widget-area .wp-block-group .widget-title',
				'pattern'  => '$',
				'key'      => 'size',
			),
		),
		'default'      => thewebs()->default( 'footer_middle_widget_spacing' ),
		'input_attrs'  => array(
			'min'     => array(
				'px'  => 0,
				'em'  => 0,
	...
	'footer_middle_top_spacing' => array(
		...
		'default'      => thewebs()->default( 'footer_middle_top_spacing' ),
		'input_attrs'  => array(
			'min'     => array(
				'px'  => 0,
				'em'  => 0,
	...
	'footer_middle_bottom_spacing' => array(
		...
		'default'      => thewebs()->default( 'footer_middle_bottom_spacing' ),
		'input_attrs'  => array(
			'min'     => array(
				'px'  => 0,
				'em'  => 0,
	...
	'footer_middle_height' => array(
		...
		'default'      => thewebs()->default( 'footer_middle_height' ),
		'input_attrs'  => array(
			'min'     => array(
				'px'  => 10,
				'em'  => 1,
	...
	'footer_middle_widget_title' => array(
		...
		'default'      => thewebs()->default( 'footer_middle_widget_title' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
	...
	'footer_middle_widget_content' => array(
		...
		'default'      => thewebs()->default( 'footer_middle_widget_content' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
	...
	'footer_middle_link_colors' => array(
		...
		'default'      => thewebs()->default( 'footer_middle_link_colors' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'footer_middle_link_style' => array(
		...
		'section'      => 'footer_middle',
		'default'      => thewebs()->default( 'footer_middle_link_style' ),
	...
	'footer_middle_background' => array(
		...
		'section'      => 'footer_middle',
		'label'        => esc_html__( 'Middle Row Background', 'thewebs' ),
		'default'      => thewebs()->default( 'footer_middle_background' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Middle Row Background', 'thewebs' ),
		),
	),
	'footer_middle_column_border' => array(
		...
		'default'      => thewebs()->default( 'footer_middle_column_border' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'footer_middle_border' => array(
		...
		'default'      => thewebs()->default( 'footer_middle_border' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	// 	'default'      => thewebs()->default( 'footer_middle_top_border' ),
	// 	'context'      => array(
	// 		array(
	// 			'setting' => '__current_tab',
	// 			'value'   => 'design',
	...
	// 	'default'      => thewebs()->default( 'footer_middle_bottom_border' ),
	// 	'context'      => array(
	// 		array(
	// 			'setting' => '__current_tab',
	// 			'value'   => 'design',
