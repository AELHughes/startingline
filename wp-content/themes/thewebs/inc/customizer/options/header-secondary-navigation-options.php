...
$settings = array(
	...
	'secondary_navigation_spacing' => array(
		...
		'default'      => thewebs()->default( 'secondary_navigation_spacing' ),
		'input_attrs'  => array(
			'min'        => array(
				'px'  => 0,
				'em'  => 0,
	...
	'secondary_navigation_stretch' => array(
		...
		'section'      => 'secondary_navigation',
		'priority'     => 6,
		'default'      => thewebs()->default( 'secondary_navigation_stretch' ),
	...
	'secondary_navigation_fill_stretch' => array(
		...
		'section'      => 'secondary_navigation',
		'priority'     => 6,
		'default'      => thewebs()->default( 'secondary_navigation_fill_stretch' ),
		'label'        => esc_html__( 'Fill and Center Menu Items?', 'thewebs' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
	...
	'secondary_navigation_style' => array(
		...
		'section'      => 'secondary_navigation',
		'priority'     => 10,
		'default'      => thewebs()->default( 'secondary_navigation_style' ),
		'label'        => esc_html__( 'Navigation Style', 'thewebs' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
		...
		'input_attrs'  => array(
			'layout' => array(
				'standard' => array(
					'tooltip' => __( 'Standard', 'thewebs' ),
					'name'    => __( 'Standard', 'thewebs' ),
					'icon'    => '',
				),
				'fullheight' => array(
					'tooltip' => __( 'Menu items are full height', 'thewebs' ),
					'name'    => __( 'Full Height', 'thewebs' ),
					'icon'    => '',
				),
				'underline' => array(
					'tooltip' => __( 'Underline Hover/Active', 'thewebs' ),
					'name'    => __( 'Underline', 'thewebs' ),
					'icon'    => '',
				),
				'underline-fullheight' => array(
					'tooltip' => __( 'Full Height Underline Hover/Active', 'thewebs' ),
					'name'    => __( 'Full Height Underline', 'thewebs' ),
					'icon'    => '',
				),
			),
			'responsive' => false,
	...
	'secondary_navigation_vertical_spacing' => array(
		...
		'default'      => thewebs()->default( 'secondary_navigation_vertical_spacing' ),
		'input_attrs'  => array(
			'min'        => array(
				'px'  => 0,
				'em'  => 0,
	...
	'secondary_navigation_color' => array(
		...
		'default'      => thewebs()->default( 'secondary_navigation_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.secondary-navigation .secondary-menu-container > ul > li.menu-item > a',
	...
	'secondary_navigation_background' => array(
		...
		'default'      => thewebs()->default( 'secondary_navigation_background' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.secondary-navigation .secondary-menu-container > ul > li.menu-item > a',
	...
	'secondary_navigation_parent_active' => array(
		...
		'sanitize'     => 'thewebs_sanitize_toggle',
		'section'      => 'secondary_navigation',
		'default'      => thewebs()->default( 'secondary_navigation_parent_active' ),
		'label'        => esc_html__( 'Make Parent of Current Menu Item Active?', 'thewebs' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'secondary_navigation_typography' => array(
		...
		'default'      => thewebs()->default( 'secondary_navigation_typography' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
				'selector' => '.secondary-navigation .secondary-menu-container > ul > li.menu-item a',
	...
	'info_secondary_submenu' => array(
		...
		'section'      => 'secondary_navigation',
		'priority'     => 20,
		'label'        => esc_html__( 'Dropdown Options', 'thewebs' ),
		'settings'     => false,
	),
