...
$settings = array(
	...
	'mobile_trigger_label' => array(
		...
		'priority'     => 6,
		'default'      => thewebs()->default( 'mobile_trigger_label' ),
		'label'        => esc_html__( 'Menu Label', 'thewebs' ),
		'live_method'     => array(
			array(
				'type'     => 'html',
	...
	'mobile_trigger_icon' => array(
		...
		'section'      => 'mobile_trigger',
		'priority'     => 10,
		'default'      => thewebs()->default( 'mobile_trigger_icon' ),
		'label'        => esc_html__( 'Trigger Icon', 'thewebs' ),
		'partial'      => array(
			'selector'            => '.menu-toggle-icon',
			'container_inclusive' => false,
			'render_callback'     => 'Thewebs\popup_toggle',
		),
		'input_attrs'  => array(
			'layout' => array(
				'menu' => array(
	...
	'mobile_trigger_style' => array(
		...
		'section'      => 'mobile_trigger_design',
		'priority'     => 10,
		'default'      => thewebs()->default( 'mobile_trigger_style' ),
		'label'        => esc_html__( 'Trigger Style', 'thewebs' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
	...
	'mobile_trigger_border' => array(
		...
		'section'      => 'mobile_trigger_design',
		'label'        => esc_html__( 'Trigger Border', 'thewebs' ),
		'default'      => thewebs()->default( 'mobile_trigger_border' ),
		'context'      => array(
			array(
	...
	'mobile_trigger_icon_size' => array(
		...
		'default'      => thewebs()->default( 'mobile_trigger_icon_size' ),
		'input_attrs'  => array(
			'min'        => array(
				'px'  => 0,
				'em'  => 0,
	...
	'mobile_trigger_color' => array(
		...
		'section'      => 'mobile_trigger_design',
		'label'        => esc_html__( 'Trigger Colors', 'thewebs' ),
		'default'      => thewebs()->default( 'mobile_trigger_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'mobile_trigger_background' => array(
		...
		'default'      => thewebs()->default( 'mobile_trigger_background' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.mobile-toggle-open-container .menu-toggle-open',
	...
	'mobile_trigger_typography' => array(
		...
		'section'      => 'mobile_trigger_design',
		'label'        => esc_html__( 'Trigger Font', 'thewebs' ),
		'context'      => array(
			array(
		...
		'default'      => thewebs()->default( 'mobile_trigger_typography' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
				'selector' => '.mobile-toggle-open-container .menu-toggle-open',
	...
	'mobile_trigger_padding' => array(
		...
		'section'      => 'mobile_trigger_design',
		'priority'     => 10,
		'default'      => thewebs()->default( 'mobile_trigger_padding' ),
		'label'        => esc_html__( 'Trigger Padding', 'thewebs' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.mobile-toggle-open-container .menu-toggle-open',
	...
	'info_link_drawer_container' => array(
		...
		'section'      => 'mobile_trigger',
		'priority'     => 20,
		'label'        => esc_html__( 'Drawer Container Options', 'thewebs' ),
		'settings'     => false,
	),
	'mobile_trigger_drawer_link' => array(
		...
		'label'        => esc_html__( 'Drawer Container Options', 'thewebs' ),
		'input_attrs'  => array(
			'section' => 'thewebs_customizer_header_popup',
		),
	),
);
