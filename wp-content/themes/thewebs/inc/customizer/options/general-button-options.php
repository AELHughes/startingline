...
Theme_Customizer::add_settings(
	array(
		'buttons_color' => array(
			...
			'default'      => thewebs()->default( 'buttons_color' ),
			'live_method'     => array(
				array(
					'type'     => 'global',
		...
		'buttons_background' => array(
			...
			'default'      => thewebs()->default( 'buttons_background' ),
			'live_method'     => array(
				array(
					'type'     => 'global',
		...
		'buttons_border_colors' => array(
			...
			'default'      => thewebs()->default( 'buttons_border' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
		...
		'buttons_border_radius' => array(
			...
			'default'      => thewebs()->default( 'buttons_border_radius' ),
			'input_attrs'  => array(
				'min'        => array(
					'px'  => 0,
					'em'  => 0,
		...
		'buttons_typography' => array(
			...
			'default'      => thewebs()->default( 'buttons_typography' ),
			'live_method'     => array(
				array(
					'type'     => 'css_typography',
					'selector' => 'button, .button, .wp-block-button__link, input[type="button"], input[type="reset"], input[type="submit"]',
		...
		'buttons_padding' => array(
			...
			'section'      => 'general_buttons',
			'priority'     => 10,
			'default'      => thewebs()->default( 'buttons_margin' ),
		...
		'buttons_shadow' => array(
			...
			'default'      => thewebs()->default( 'buttons_shadow' ),
		),
		'buttons_shadow_hover' => array(
			...
			'default'      => thewebs()->default( 'buttons_shadow_hover' ),
		),
	)
);
