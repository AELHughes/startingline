...
$settings = array(
	...
	'primary_navigation_spacing' => array(
		...
		'default'      => thewebs()->default( 'primary_navigation_spacing' ),
		'input_attrs'  => array(
			'min'        => array(
				'px'  => 0,
				'em'  => 0,
	...
	'primary_navigation_stretch' => array(
		...
		'section'      => 'primary_navigation',
		'priority'     => 6,
		'default'      => thewebs()->default( 'primary_navigation_stretch' ),
	...
	'primary_navigation_fill_stretch' => array(
		...
		'section'      => 'primary_navigation',
		'priority'     => 6,
		'default'      => thewebs()->default( 'primary_navigation_fill_stretch' ),
	...
	'primary_navigation_style' => array(
		...
		'section'      => 'primary_navigation',
		'priority'     => 10,
		'default'      => thewebs()->default( 'primary_navigation_style' ),
	...
	'primary_navigation_vertical_spacing' => array(
		...
		'default'      => thewebs()->default( 'primary_navigation_vertical_spacing' ),
		'input_attrs'  => array(
			'min'        => array(
				'px'  => 0,
				'em'  => 0,
	...
	'primary_navigation_color' => array(
		...
		'default'      => thewebs()->default( 'primary_navigation_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.main-navigation .primary-menu-container > ul > li.menu-item > a',
	...
	'primary_navigation_background' => array(
		...
		'default'      => thewebs()->default( 'primary_navigation_background' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.main-navigation .primary-menu-container > ul > li.menu-item > a',
	...
	'primary_navigation_parent_active' => array(
		...
		'sanitize'     => 'thewebs_sanitize_toggle',
		'section'      => 'primary_navigation',
		'default'      => thewebs()->default( 'primary_navigation_parent_active' ),
	...
	'primary_navigation_typography' => array(
		...
		'default'      => thewebs()->default( 'primary_navigation_typography' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
				'selector' => '.main-navigation .primary-menu-container > ul > li.menu-item a',
