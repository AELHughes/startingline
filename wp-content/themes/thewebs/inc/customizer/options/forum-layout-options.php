...
Theme_Customizer::add_settings(
	array(
		...
		'info_forum_title' => array(
			...
			'section'      => 'forum_layout',
			'priority'     => 2,
			'label'        => esc_html__( 'Forum Title', 'thewebs' ),
			'settings'     => false,
		),
		...
		'forum_title' => array(
			...
			'section'      => 'forum_layout',
			'priority'     => 3,
			'default'      => thewebs()->default( 'forum_title' ),
			'label'        => esc_html__( 'Show Forum Title?', 'thewebs' ),
			'transport'    => 'refresh',
		),
		'forum_title_layout' => array(
			'control_type' => 'thewebs_radio_icon_control',
			'section'      => 'forum_layout',
			'label'        => esc_html__( 'Forum Title Layout', 'thewebs' ),
			'transport'    => 'refresh',
			'priority'     => 4,
			'default'      => thewebs()->default( 'forum_title_layout' ),
			'context'      => array(
				array(
					'setting'    => 'forum_title',
					'operator'   => '=',
		...
		'forum_title_inner_layout' => array(
			...
			'section'      => 'forum_layout',
			'priority'     => 4,
			'default'      => thewebs()->default( 'forum_title_inner_layout' ),
		...
		'forum_title_align' => array(
			'control_type' => 'thewebs_radio_icon_control',
			'section'      => 'forum_layout',
			'label'        => esc_html__( 'Forum Title Align', 'thewebs' ),
			'priority'     => 4,
			'default'      => thewebs()->default( 'forum_title_align' ),
			'context'      => array(
				array(
					'setting'    => 'forum_title',
					'operator'   => '=',
		...
		'forum_title_height' => array(
			...
			'default'      => thewebs()->default( 'forum_title_height' ),
			'input_attrs'  => array(
				'min'     => array(
					'px'  => 10,
					'em'  => 1,
		...
		'forum_title_elements' => array(
			...
			'section'      => 'forum_layout',
			'priority'     => 6,
			'default'      => thewebs()->default( 'forum_title_elements' ),
		...
		'forum_title_font' => array(
			...
			'section'      => 'forum_layout_design',
			'label'        => esc_html__( 'Forum Title Font', 'thewebs' ),
			'default'      => thewebs()->default( 'forum_title_font' ),
			'live_method'     => array(
				array(
					'type'     => 'css_typography',
		...
		'forum_title_search_width' => array(
			'control_type' => 'thewebs_range_control',
			'section'      => 'forum_layout_design',
			'label'        => esc_html__( 'Search Bar Width', 'thewebs' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
			...
			'default'      => thewebs()->default( 'forum_title_search_width' ),
			'input_attrs'  => array(
				'min'        => array(
					'px'  => 100,
					'em'  => 4,
		...
		'forum_title_search_color' => array(
			...
			'section'      => 'forum_layout_design',
			'label'        => esc_html__( 'Input Text Colors', 'thewebs' ),
			'default'      => thewebs()->default( 'forum_title_search_color' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '.forum-title .bbp-search-form input.search-field, .forum-title .bbp-search-form .thewebs-search-icon-wrap',
					'property' => 'color',
					'pattern'  => '$',
					'key'      => 'color',
				),
				array(
					'type'     => 'css',
					'selector' => '.forum-title .bbp-search-form input.search-field:focus, .forum-title .bbp-search-form input.search-submit:hover ~ .thewebs-search-icon-wrap',
					'property' => 'color',
					'pattern'  => '$',
					'key'      => 'hover',
				),
			...
			'input_attrs'  => array(
				'colors' => array(
					...
					'hover' => array(
						'tooltip' => __( 'Focus Color', 'thewebs' ),
						'palette' => true,
					),
				),
			),
		...
		'forum_title_search_background' => array(
			'control_type' => 'thewebs_color_control',
			'section'      => 'forum_layout_design',
			'label'        => esc_html__( 'Input Background', 'thewebs' ),
			'default'      => thewebs()->default( 'forum_title_search_background' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
		...
		'forum_title_search_border' => array(
			...
			'default'      => thewebs()->default( 'forum_title_search_border' ),
			'live_method'     => array(
				array(
					'type'     => 'css_border',
					'selector' => '.forum-title .bbp-search-form input.search-field',
		...
		'forum_title_search_border_color' => array(
			'control_type' => 'thewebs_color_control',
			'section'      => 'forum_layout_design',
			'label'        => esc_html__( 'Input Border Color', 'thewebs' ),
			'default'      => thewebs()->default( 'forum_title_search_border_color' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '.forum-title .bbp-search-form input.search-field',
		...
		'forum_title_search_typography' => array(
			...
			'default'      => thewebs()->default( 'forum_title_search_typography' ),
			'live_method'     => array(
				array(
					'type'     => 'css_typography',
					'selector' => '.forum-title .bbp-search-form input.search-field',
		...
		'forum_title_search_margin' => array(
			...
			'section'      => 'forum_layout_design',
			'default'      => thewebs()->default( 'forum_title_search_margin' ),
		...
		'forum_title_breadcrumb_color' => array(
			...
			'default'      => thewebs()->default( 'forum_title_breadcrumb_color' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '.forum-title .thewebs-breadcrumbs',
					'property' => 'color',
					'pattern'  => '$',
					'key'      => 'color',
				),
				array(
					'type'     => 'css',
					'selector' => '.forum-title .thewebs-breadcrumbs a:hover',
					'property' => 'color',
					'pattern'  => '$',
					'key'      => 'hover',
				),
		...
		'forum_title_breadcrumb_font' => array(
			...
			'default'      => thewebs()->default( 'forum_title_breadcrumb_font' ),
			'live_method'     => array(
				array(
					'type'     => 'css_typography',
					'selector' => '.forum-title .thewebs-breadcrumbs',
		...
		'forum_title_description_color' => array(
			...
			'default'      => thewebs()->default( 'forum_title_description_color' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
		...
		'forum_title_description_font' => array(
			'control_type' => 'thewebs_typography_control',
			'section'      => 'forum_layout_design',
			'label'        => esc_html__( 'Description Font', 'thewebs' ),
			'default'      => thewebs()->default( 'forum_title_description_font' ),
			'live_method'     => array(
				array(
					'type'     => 'css_typography',
					'selector' => '.forum-title .title-entry-description',
		...
		'forum_title_background' => array(
			...
			'section'      => 'forum_layout_design',
			'label'        => esc_html__( 'Forum Above Area Background', 'thewebs' ),
			'default'      => thewebs()->default( 'forum_title_background' ),
			'context'      => array(
				array(
					'setting'    => 'forum_title',
					'operator'   => '=',
			...
			'input_attrs'  => array(
				'tooltip'  => __( 'Forum Title Background', 'thewebs' ),
			),
		),
		'forum_title_featured_image' => array(
			...
			'sanitize'     => 'thewebs_sanitize_toggle',
			'section'      => 'forum_layout_design',
			'default'      => thewebs()->default( 'forum_title_featured_image' ),
		...
		'forum_title_overlay_color' => array(
			...
			'default'      => thewebs()->default( 'forum_title_overlay_color' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
		...
		'forum_title_border' => array(
			...
			'section'      => 'forum_layout_design',
			'label'        => esc_html__( 'Border', 'thewebs' ),
			'default'      => thewebs()->default( 'forum_title_border' ),
			'context'      => array(
				array(
					'setting'    => 'forum_title',
					'operator'   => '=',
		...
		'info_forum_layout' => array(
			...
			'section'      => 'forum_layout',
			'priority'     => 10,
			'label'        => esc_html__( 'Forum Layout', 'thewebs' ),
			'settings'     => false,
		),
		...
		'forum_layout' => array(
			...
			'transport'    => 'refresh',
			'priority'     => 10,
			'default'      => thewebs()->default( 'forum_layout' ),
			'input_attrs'  => array(
				'layout' => array(
					'normal' => array(
		...
		'forum_sidebar_id' => array(
			...
			'section'      => 'forum_layout',
			'label'        => esc_html__( 'Forum Default Sidebar', 'thewebs' ),
			'transport'    => 'refresh',
			'priority'     => 10,
			'default'      => thewebs()->default( 'forum_sidebar_id' ),
			'input_attrs'  => array(
		...
		'forum_content_style' => array(
			...
			'priority'     => 10,
			'default'      => thewebs()->default( 'forum_content_style' ),
			'live_method'     => array(
				array(
					'type'     => 'class',
		...
		'forum_vertical_padding' => array(
			...
			'priority'     => 10,
			'default'      => thewebs()->default( 'forum_vertical_padding' ),
			'live_method'     => array(
				array(
					'type'     => 'class',
					'selector' => 'body.single-forum',
		...
		'forum_background' => array(
			...
			'default'      => thewebs()->default( 'forum_background' ),
			'live_method'     => array(
				array(
					'type'     => 'css_background',
					'selector' => 'body.single-forum',
			...
			'input_attrs'  => array(
				'tooltip' => __( 'Forum Background', 'thewebs' ),
			),
		),
		'forum_content_background' => array(
			...
			'default'      => thewebs()->default( 'forum_content_background' ),
			'live_method'  => array(
				array(
					'type'     => 'css_background',
			...
			'input_attrs'  => array(
				'tooltip' => __( 'Forum Content Background', 'thewebs' ),
			),
		),
	)
);
