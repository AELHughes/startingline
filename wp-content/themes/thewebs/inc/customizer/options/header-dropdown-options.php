...
Theme_Customizer::add_settings(
	array(
		...
		'dropdown_navigation_color' => array(
			...
			'section'      => 'dropdown_navigation_design',
			'label'        => esc_html__( 'Dropdown Colors', 'thewebs' ),
			'default'      => thewebs()->default( 'dropdown_navigation_color' ),
			'live_method'  => array(
				array(
					'type'     => 'css',
		...
		'dropdown_navigation_background' => array(
			...
			'section'      => 'dropdown_navigation_design',
			'priority'     => 20,
			'label'        => esc_html__( 'Dropdown Background', 'thewebs' ),
			'default'      => thewebs()->default( 'dropdown_navigation_background' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '.header-navigation .header-menu-container ul ul li.menu-item > a',
		...
		'dropdown_navigation_divider' => array(
			...
			'section'      => 'dropdown_navigation_design',
			'priority'     => 20,
			'label'        => esc_html__( 'Item Divider', 'thewebs' ),
			'default'      => thewebs()->default( 'dropdown_navigation_divider' ),
			'live_method'     => array(
				array(
					'type'     => 'css_border',
		...
		'dropdown_navigation_typography' => array(
			...
			'section'      => 'dropdown_navigation_design',
			'priority'     => 20,
			'label'        => esc_html__( 'Dropdown Font', 'thewebs' ),
			'default'      => thewebs()->default( 'dropdown_navigation_typography' ),
			'live_method'     => array(
				array(
					'type'     => 'css_typography',
					'selector' => '.header-navigation .header-menu-container ul ul li.menu-item > a',
		...
		'dropdown_navigation_shadow' => array(
			...
			'section'      => 'dropdown_navigation_design',
			'priority'     => 20,
			'label'        => esc_html__( 'Dropdown Shadow', 'thewebs' ),
			'live_method'     => array(
				array(
					'type'     => 'css_boxshadow',
			...
			'default'      => thewebs()->default( 'dropdown_navigation_shadow' ),
		),
		'dropdown_navigation_reveal' => array(
			'control_type' => 'thewebs_radio_icon_control',
			'section'      => 'dropdown_navigation',
			'priority'     => 20,
			'default'      => thewebs()->default( 'dropdown_navigation_reveal' ),
			'label'        => esc_html__( 'Dropdown Reveal', 'thewebs' ),
			'live_method'     => array(
				array(
					'type'     => 'class',
			...
			'input_attrs'  => array(
				'layout' => array(
					...
					'fade-up' => array(
						'name'    => __( 'Fade Up', 'thewebs' ),
					),
					'fade-down' => array(
						'name'    => __( 'Fade Down', 'thewebs' ),
					),
				),
				'responsive' => false,
			),
		...
		'dropdown_navigation_width' => array(
			...
			'section'      => 'dropdown_navigation',
			'priority'     => 20,
			'label'        => esc_html__( 'Dropdown Width', 'thewebs' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
			...
			'default'      => thewebs()->default( 'dropdown_navigation_width' ),
			'input_attrs'  => array(
				'min'        => array(
					'px'  => 0,
					'em'  => 0,
		...
		'dropdown_navigation_vertical_spacing' => array(
			...
			'section'      => 'dropdown_navigation',
			'priority'     => 20,
			'label'        => esc_html__( 'Dropdown Items Vertical Spacing', 'thewebs' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '.header-navigation .header-menu-container ul ul li.menu-item > a',
			...
			'default'      => thewebs()->default( 'dropdown_navigation_vertical_spacing' ),
			'input_attrs'  => array(
				'min'        => array(
					'px'  => 0,
					'em'  => 0,
