...
Theme_Customizer::add_settings(
	array(
		...
		'topic_title' => array(
			...
			'section'      => 'topic_layout',
			'priority'     => 3,
			'default'      => thewebs()->default( 'topic_title' ),
		...
		'topic_title_layout' => array(
			...
			'transport'    => 'refresh',
			'priority'     => 4,
			'default'      => thewebs()->default( 'topic_title_layout' ),
			'context'      => array(
				array(
					'setting'    => 'topic_title',
					'operator'   => '=',
		...
		'topic_title_inner_layout' => array(
			...
			'section'      => 'topic_layout',
			'priority'     => 4,
			'default'      => thewebs()->default( 'topic_title_inner_layout' ),
		...
		'topic_title_align' => array(
			...
			'priority'     => 4,
			'default'      => thewebs()->default( 'topic_title_align' ),
			'context'      => array(
				array(
					'setting'    => 'topic_title',
					'operator'   => '=',
		...
		'topic_title_height' => array(
			...
			'default'      => thewebs()->default( 'topic_title_height' ),
			'input_attrs'  => array(
				'min'     => array(
					'px'  => 10,
					'em'  => 1,
		...
		'topic_title_elements' => array(
			...
			'section'      => 'topic_layout',
			'priority'     => 6,
			'default'      => thewebs()->default( 'topic_title_elements' ),
		...
		'topic_title_font' => array(
			...
			'default'      => thewebs()->default( 'topic_title_font' ),
			'live_method'     => array(
				array(
					'type'     => 'css_typography',
		...
		'topic_title_search_width' => array(
			...
			'default'      => thewebs()->default( 'topic_title_search_width' ),
			'input_attrs'  => array(
				'min'        => array(
					'px'  => 100,
					'em'  => 4,
		...
		'topic_title_search_color' => array(
			...
			'default'      => thewebs()->default( 'topic_title_search_color' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '.topic-title .bbp-search-form input.search-field, .topic-title .bbp-search-form .thewebs-search-icon-wrap',
					'property' => 'color',
					'pattern'  => '$',
					'key'      => 'color',
				),
				array(
					'type'     => 'css',
					'selector' => '.topic-title .bbp-search-form input.search-field:focus, .topic-title .bbp-search-form input.search-submit:hover ~ .thewebs-search-icon-wrap',
					'property' => 'color',
					'pattern'  => '$',
					'key'      => 'hover',
				),
		...
		'topic_title_search_background' => array(
			...
			'default'      => thewebs()->default( 'topic_title_search_background' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
		...
		'topic_title_search_border' => array(
			...
			'default'      => thewebs()->default( 'topic_title_search_border' ),
			'live_method'     => array(
				array(
					'type'     => 'css_border',
					'selector' => '.topic-title .bbp-search-form input.search-field',
		...
		'topic_title_search_border_color' => array(
			...
			'default'      => thewebs()->default( 'topic_title_search_border_color' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '.topic-title .bbp-search-form input.search-field',
		...
		'topic_title_search_typography' => array(
			...
			'default'      => thewebs()->default( 'topic_title_search_typography' ),
			'live_method'     => array(
				array(
					'type'     => 'css_typography',
					'selector' => '.topic-title .bbp-search-form input.search-field',
		...
		'topic_title_search_margin' => array(
			...
			'section'      => 'topic_layout_design',
			'default'      => thewebs()->default( 'topic_title_search_margin' ),
		...
		'topic_title_breadcrumb_color' => array(
			...
			'default'      => thewebs()->default( 'topic_title_breadcrumb_color' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '.topic-title .thewebs-breadcrumbs',
					'property' => 'color',
					'pattern'  => '$',
					'key'      => 'color',
				),
				array(
					'type'     => 'css',
					'selector' => '.topic-title .thewebs-breadcrumbs a:hover',
					'property' => 'color',
					'pattern'  => '$',
					'key'      => 'hover',
				),
		...
		'topic_title_breadcrumb_font' => array(
			...
			'default'      => thewebs()->default( 'topic_title_breadcrumb_font' ),
			'live_method'     => array(
				array(
					'type'     => 'css_typography',
					'selector' => '.topic-title .thewebs-breadcrumbs',
		...
		'topic_title_info_color' => array(
			'control_type' => 'thewebs_color_control',
			'section'      => 'topic_layout_design',
			'label'        => esc_html__( 'Info Colors', 'thewebs' ),
			'default'      => thewebs()->default( 'topic_title_info_color' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
		...
		'topic_title_info_font' => array(
			...
			'default'      => thewebs()->default( 'topic_title_info_font' ),
			'live_method'     => array(
				array(
					'type'     => 'css_typography',
		...
		'topic_title_background' => array(
			...
			'default'      => thewebs()->default( 'topic_title_background' ),
			'context'      => array(
				array(
					'setting'    => 'topic_title',
					'operator'   => '=',
		...
		'topic_title_overlay_color' => array(
			...
			'default'      => thewebs()->default( 'topic_title_overlay_color' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
		...
		'topic_title_border' => array(
			...
			'section'      => 'topic_layout_design',
			'label'        => esc_html__( 'Border', 'thewebs' ),
			'default'      => thewebs()->default( 'topic_title_border' ),
			'context'      => array(
				array(
					'setting'    => 'topic_title',
					'operator'   => '=',
		...
		'topic_layout' => array(
			...
			'transport'    => 'refresh',
			'priority'     => 10,
			'default'      => thewebs()->default( 'topic_layout' ),
			'input_attrs'  => array(
				'layout' => array(
					'normal' => array(
		...
		'topic_sidebar_id' => array(
			...
			'transport'    => 'refresh',
			'priority'     => 10,
			'default'      => thewebs()->default( 'topic_sidebar_id' ),
			'input_attrs'  => array(
		...
		'topic_content_style' => array(
			...
			'priority'     => 10,
			'default'      => thewebs()->default( 'topic_content_style' ),
			'live_method'     => array(
				array(
					'type'     => 'class',
		...
		'topic_vertical_padding' => array(
			...
			'priority'     => 10,
			'default'      => thewebs()->default( 'topic_vertical_padding' ),
			'live_method'     => array(
				array(
					'type'     => 'class',
		...
		'topic_background' => array(
			...
			'default'      => thewebs()->default( 'topic_background' ),
			'live_method'     => array(
				array(
					'type'     => 'css_background',
					'selector' => 'body.single-topic',
		...
		'topic_content_background' => array(
			...
			'default'      => thewebs()->default( 'topic_content_background' ),
			'live_method'  => array(
				array(
					'type'     => 'css_background',
