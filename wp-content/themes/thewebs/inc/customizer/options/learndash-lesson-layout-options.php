...
$settings = array(
	...
	'sfwd-lessons_title' => array(
		...
		'section'      => 'sfwd_lesson_layout',
		'priority'     => 3,
		'default'      => thewebs()->default( 'sfwd-lessons_title' ),
	...
	'sfwd-lessons_title_layout' => array(
		...
		'transport'    => 'refresh',
		'priority'     => 4,
		'default'      => thewebs()->default( 'sfwd-lessons_title_layout' ),
		'context'      => array(
			array(
	...
	'sfwd-lessons_title_inner_layout' => array(
		...
		'section'      => 'sfwd_lesson_layout',
		'priority'     => 4,
		'default'      => thewebs()->default( 'sfwd-lessons_title_inner_layout' ),
	...
	'sfwd-lessons_title_align' => array(
		...
		'priority'     => 4,
		'default'      => thewebs()->default( 'sfwd-lessons_title_align' ),
		'context'      => array(
			array(
				'setting'    => 'sfwd-lessons_title',
				'operator'   => '=',
	...
	'sfwd-lessons_title_height' => array(
		...
		'default'      => thewebs()->default( 'sfwd-lessons_title_height' ),
		'input_attrs'  => array(
			'min'     => array(
				'px'  => 10,
				'em'  => 1,
	...
	'sfwd-lessons_title_elements' => array(
		...
		'section'      => 'sfwd_lesson_layout',
		'priority'     => 6,
		'default'      => thewebs()->default( 'sfwd-lessons_title_elements' ),
	...
	'sfwd-lessons_title_font' => array(
		...
		'default'      => thewebs()->default( 'sfwd-lessons_title_font' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
	...
	'sfwd-lessons_title_breadcrumb_color' => array(
		...
		'default'      => thewebs()->default( 'sfwd-lessons_title_breadcrumb_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.sfwd-lessons-title .thewebs-breadcrumbs',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'color',
			),
			array(
				'type'     => 'css',
				'selector' => '.sfwd-lessons-title .thewebs-breadcrumbs a:hover',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'hover',
			),
	...
	'sfwd-lessons_title_breadcrumb_font' => array(
		...
		'default'      => thewebs()->default( 'sfwd-lessons_title_breadcrumb_font' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
				'selector' => '.sfwd-lessons-title .thewebs-breadcrumbs',
	...
	'sfwd-lessons_title_background' => array(
		...
		'default'      => thewebs()->default( 'sfwd-lessons_title_background' ),
		'context'      => array(
			array(
				'setting'    => 'sfwd-lessons_title',
				'operator'   => '=',
	...
	'sfwd-lessons_title_featured_image' => array(
		...
		'sanitize'     => 'thewebs_sanitize_toggle',
		'section'      => 'sfwd_lesson_layout_design',
		'default'      => thewebs()->default( 'sfwd-lessons_title_featured_image' ),
	...
	'sfwd-lessons_title_overlay_color' => array(
		...
		'default'      => thewebs()->default( 'sfwd-lessons_title_overlay_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'sfwd-lessons_title_border' => array(
		...
		'default'      => thewebs()->default( 'sfwd-lessons_title_border' ),
		'context'      => array(
			array(
				'setting'    => 'sfwd-lessons_title',
				'operator'   => '=',
	...
	'sfwd-lessons_layout' => array(
		...
		'transport'    => 'refresh',
		'priority'     => 10,
		'default'      => thewebs()->default( 'sfwd-lessons_layout' ),
		'input_attrs'  => array(
			'layout' => array(
				'normal' => array(
	...
	'sfwd-lessons_sidebar_id' => array(
		...
		'transport'    => 'refresh',
		'priority'     => 10,
		'default'      => thewebs()->default( 'sfwd-lessons_sidebar_id' ),
		'input_attrs'  => array(
	...
	'sfwd-lessons_content_style' => array(
		...
		'priority'     => 10,
		'default'      => thewebs()->default( 'sfwd-lessons_content_style' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
	...
	'sfwd-lessons_vertical_padding' => array(
		...
		'priority'     => 10,
		'default'      => thewebs()->default( 'sfwd-lessons_vertical_padding' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
				'selector' => 'body.single-sfwd-lessons',
	...
	'sfwd-lessons_feature' => array(
		...
		'section'      => 'sfwd_lesson_layout',
		'priority'     => 20,
		'default'      => thewebs()->default( 'sfwd-lessons_feature' ),
	...
	'sfwd-lessons_feature_position' => array(
		...
		'priority'     => 20,
		'transport'    => 'refresh',
		'default'      => thewebs()->default( 'sfwd-lessons_feature_position' ),
		'context'      => array(
			array(
	...
	'sfwd-lessons_feature_ratio' => array(
		...
		'priority'     => 20,
		'default'      => thewebs()->default( 'sfwd-lessons_feature_ratio' ),
		'context'      => array(
			array(
				'setting'    => 'sfwd-lessons_feature',
				'operator'   => '=',
	...
	'sfwd-lessons_background' => array(
		...
		'default'      => thewebs()->default( 'sfwd-lessons_background' ),
		'live_method'     => array(
			array(
				'type'     => 'css_background',
				'selector' => 'body.single-sfwd-lessons',
	...
	'sfwd-lessons_content_background' => array(
		...
		'default'      => thewebs()->default( 'sfwd-lessons_content_background' ),
		'live_method'  => array(
			array(
				'type'     => 'css_background',
