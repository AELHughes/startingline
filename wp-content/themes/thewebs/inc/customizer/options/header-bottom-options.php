...
$settings = array(
	...
	'header_bottom_layout' => array(
		...
		'section'      => 'header_bottom',
		'priority'     => 4,
		'default'      => thewebs()->default( 'header_bottom_layout' ),
	...
	'header_bottom_height' => array(
		...
		'default'      => thewebs()->default( 'header_bottom_height' ),
		'input_attrs'  => array(
			'min'     => array(
				'px'  => 0,
				'em'  => 0,
	...
	'header_bottom_background' => array(
		...
		'default'      => thewebs()->default( 'header_bottom_background' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'header_bottom_border' => array(
		...
		'default'      => thewebs()->default( 'header_bottom_border' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'header_bottom_trans_background' => array(
		'control_type' => 'thewebs_background_control',
		'section'      => 'header_bottom',
		'label'        => esc_html__( '(When Transparent Header) Bottom Row Background', 'thewebs' ),
		'default'      => thewebs()->default( 'header_bottom_trans_background' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Transparent Header Bottom Row Background', 'thewebs' ),
		),
	),
	'header_bottom_padding' => array(
		'control_type' => 'thewebs_measure_control',
		'section'      => 'header_bottom',
		'default'      => thewebs()->default( 'header_bottom_padding' ),
