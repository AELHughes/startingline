...
$settings = array(
	...
	'header_main_layout' => array(
		...
		'section'      => 'header_main',
		'priority'     => 4,
		'default'      => thewebs()->default( 'header_main_layout' ),
	...
	'header_main_height' => array(
		...
		'transport'    => ( 'no' !== thewebs()->option( 'header_sticky' ) ? 'refresh' : 'postMessage' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
		...
		'default'      => thewebs()->default( 'header_main_height' ),
		'input_attrs'  => array(
			'min'     => array(
				'px'  => 10,
				'em'  => 1,
	...
	'header_main_background' => array(
		...
		'section'      => 'header_main',
		'label'        => esc_html__( 'Main Row Background', 'thewebs' ),
		'default'      => thewebs()->default( 'header_main_background' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Main Row Background', 'thewebs' ),
		),
	),
	'header_main_border' => array(
		...
		'default'      => thewebs()->default( 'header_main_border' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'header_main_padding' => array(
		...
		'section'      => 'header_main',
		'default'      => thewebs()->default( 'header_main_padding' ),
	...
	'header_main_trans_background' => array(
		'control_type' => 'thewebs_background_control',
		'section'      => 'header_main',
		'label'        => esc_html__( '(When Transparent Header) Main Row Background', 'thewebs' ),
		'default'      => thewebs()->default( 'header_main_trans_background' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Transparent Header Main Row Background', 'thewebs' ),
		),
	),
);
