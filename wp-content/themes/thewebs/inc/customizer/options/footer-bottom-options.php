...
Theme_Customizer::add_settings(
	array(
		...
		'footer_bottom_contain' => array(
			...
			'section'      => 'footer_bottom',
			'priority'     => 4,
			'default'      => thewebs()->default( 'footer_bottom_contain' ),
		...
		'footer_bottom_columns' => array(
			...
			'priority'     => 5,
			//'transport'    => 'refresh',
			'default'      => thewebs()->default( 'footer_bottom_columns' ),
			'partial'      => array(
				'selector'            => '#colophon',
		...
		'footer_bottom_layout' => array(
			...
			'priority'     => 5,
			//'transport'    => 'refresh',
			'default'      => thewebs()->default( 'footer_bottom_layout' ),
			'live_method'     => array(
				array(
					'type'     => 'class',
		...
		'footer_bottom_collapse' => array(
			...
			'section'      => 'footer_bottom',
			'priority'     => 5,
			'default'      => thewebs()->default( 'footer_bottom_collapse' ),
		...
		'footer_bottom_direction' => array(
			...
			'section'      => 'footer_bottom',
			'priority'     => 5,
			'default'      => thewebs()->default( 'footer_bottom_direction' ),
		...
		'footer_bottom_column_spacing' => array(
			...
			'default'      => thewebs()->default( 'footer_bottom_column_spacing' ),
			'input_attrs'  => array(
				'min'     => array(
					'px'  => 0,
					'em'  => 0,
		...
		'footer_bottom_widget_spacing' => array(
			...
			'default'      => thewebs()->default( 'footer_bottom_widget_spacing' ),
			'input_attrs'  => array(
				'min'     => array(
					'px'  => 0,
					'em'  => 0,
		...
		'footer_bottom_top_spacing' => array(
			...
			'default'      => thewebs()->default( 'footer_bottom_top_spacing' ),
			'input_attrs'  => array(
				'min'     => array(
					'px'  => 0,
					'em'  => 0,
		...
		'footer_bottom_bottom_spacing' => array(
			...
			'default'      => thewebs()->default( 'footer_bottom_bottom_spacing' ),
			'input_attrs'  => array(
				'min'     => array(
					'px'  => 0,
					'em'  => 0,
		...
		'footer_bottom_height' => array(
			...
			'default'      => thewebs()->default( 'footer_bottom_height' ),
			'input_attrs'  => array(
				'min'     => array(
					'px'  => 10,
					'em'  => 1,
		...
		'footer_bottom_widget_title' => array(
			...
			'default'      => thewebs()->default( 'footer_bottom_widget_title' ),
			'live_method'     => array(
				array(
					'type'     => 'css_typography',
		...
		'footer_bottom_widget_content' => array(
			...
			'default'      => thewebs()->default( 'footer_bottom_widget_content' ),
			'live_method'     => array(
				array(
					'type'     => 'css_typography',
		...
		'footer_bottom_link_colors' => array(
			...
			'default'      => thewebs()->default( 'footer_bottom_link_colors' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
		...
		'footer_bottom_link_style' => array(
			...
			'section'      => 'footer_bottom_design',
			'default'      => thewebs()->default( 'footer_bottom_link_style' ),
		...
		'footer_bottom_background' => array(
			...
			'section'      => 'footer_bottom_design',
			'label'        => esc_html__( 'Bottom Row Background', 'thewebs' ),
			'default'      => thewebs()->default( 'footer_bottom_background' ),
			'live_method'     => array(
				array(
					'type'     => 'css_background',
					'selector' => '.site-bottom-footer-wrap .site-footer-row-container-inner',
			...
			'input_attrs'  => array(
				'tooltip'  => __( 'Bottom Row Background', 'thewebs' ),
			),
		),
		'footer_bottom_column_border' => array(
			...
			'default'      => thewebs()->default( 'footer_bottom_column_border' ),
			'live_method'     => array(
				array(
					'type'     => 'css_border',
		...
		'footer_bottom_border' => array(
			...
			'default'      => thewebs()->default( 'footer_bottom_border' ),
			'settings'     => array(
