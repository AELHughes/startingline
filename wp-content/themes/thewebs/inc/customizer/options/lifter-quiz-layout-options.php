...
$settings = array(
	...
	'llms_quiz_title' => array(
		...
		'section'      => 'llms_quiz_layout',
		'priority'     => 3,
		'default'      => thewebs()->default( 'llms_quiz_title' ),
	...
	'llms_quiz_title_layout' => array(
		...
		'transport'    => 'refresh',
		'priority'     => 4,
		'default'      => thewebs()->default( 'llms_quiz_title_layout' ),
		'context'      => array(
			array(
	...
	'llms_quiz_title_inner_layout' => array(
		...
		'section'      => 'llms_quiz_layout',
		'priority'     => 4,
		'default'      => thewebs()->default( 'llms_quiz_title_inner_layout' ),
	...
	'llms_quiz_title_align' => array(
		...
		'priority'     => 4,
		'default'      => thewebs()->default( 'llms_quiz_title_align' ),
		'context'      => array(
			array(
				'setting'    => 'llms_quiz_title',
				'operator'   => '=',
	...
	'llms_quiz_layout' => array(
		...
		'transport'    => 'refresh',
		'priority'     => 10,
		'default'      => thewebs()->default( 'llms_quiz_layout' ),
		'input_attrs'  => array(
			'layout' => array(
				'normal' => array(
	...
	'llms_quiz_sidebar_id' => array(
		...
		'transport'    => 'refresh',
		'priority'     => 10,
		'default'      => thewebs()->default( 'llms_quiz_sidebar_id' ),
		'input_attrs'  => array(
	...
	'llms_quiz_content_style' => array(
		...
		'priority'     => 10,
		'default'      => thewebs()->default( 'llms_quiz_content_style' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
	...
	'llms_quiz_vertical_padding' => array(
		...
		'priority'     => 10,
		'default'      => thewebs()->default( 'llms_quiz_vertical_padding' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
				'selector' => 'body.single-llms_quiz',
