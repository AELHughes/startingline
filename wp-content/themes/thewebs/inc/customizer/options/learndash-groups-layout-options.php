...
$settings = array(
	...
	'info_groups_title' => array(
		...
		'section'      => 'sfwd_groups_layout',
		'priority'     => 2,
		'label'        => esc_html__( 'Group Title', 'thewebs' ),
		'settings'     => false,
	),
	...
	'groups_title' => array(
		...
		'section'      => 'sfwd_groups_layout',
		'priority'     => 3,
		'default'      => thewebs()->default( 'groups_title' ),
		'label'        => esc_html__( 'Show Group Title?', 'thewebs' ),
		'transport'    => 'refresh',
	),
	'groups_title_layout' => array(
		'control_type' => 'thewebs_radio_icon_control',
		'section'      => 'sfwd_groups_layout',
		'label'        => esc_html__( 'Group Title Layout', 'thewebs' ),
		'transport'    => 'refresh',
		'priority'     => 4,
		'default'      => thewebs()->default( 'groups_title_layout' ),
		'context'      => array(
			array(
	...
	'groups_title_inner_layout' => array(
		...
		'section'      => 'sfwd_groups_layout',
		'priority'     => 4,
		'default'      => thewebs()->default( 'groups_title_inner_layout' ),
	...
	'groups_title_align' => array(
		'control_type' => 'thewebs_radio_icon_control',
		'section'      => 'sfwd_groups_layout',
		'label'        => esc_html__( 'Group Title Align', 'thewebs' ),
		'priority'     => 4,
		'default'      => thewebs()->default( 'groups_title_align' ),
		'context'      => array(
			array(
				'setting'    => 'groups_title',
				'operator'   => '=',
	...
	'groups_title_height' => array(
		...
		'default'      => thewebs()->default( 'groups_title_height' ),
		'input_attrs'  => array(
			'min'     => array(
				'px'  => 10,
				'em'  => 1,
	...
	'groups_title_elements' => array(
		...
		'section'      => 'sfwd_groups_layout',
		'priority'     => 6,
		'default'      => thewebs()->default( 'groups_title_elements' ),
	...
	'groups_title_font' => array(
		...
		'section'      => 'sfwd_groups_layout_design',
		'label'        => esc_html__( 'Group Title Font', 'thewebs' ),
		'default'      => thewebs()->default( 'groups_title_font' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
	...
	'groups_title_breadcrumb_color' => array(
		...
		'default'      => thewebs()->default( 'groups_title_breadcrumb_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.groups-title .thewebs-breadcrumbs',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'color',
			),
			array(
				'type'     => 'css',
				'selector' => '.groups-title .thewebs-breadcrumbs a:hover',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'hover',
			),
	...
	'groups_title_breadcrumb_font' => array(
		...
		'default'      => thewebs()->default( 'groups_title_breadcrumb_font' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
				'selector' => '.groups-title .thewebs-breadcrumbs',
	...
	'groups_title_background' => array(
		...
		'section'      => 'sfwd_groups_layout_design',
		'label'        => esc_html__( 'Group Above Area Background', 'thewebs' ),
		'default'      => thewebs()->default( 'groups_title_background' ),
		'context'      => array(
			array(
				'setting'    => 'groups_title',
				'operator'   => '=',
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Group Title Background', 'thewebs' ),
		),
	),
	'groups_title_featured_image' => array(
		...
		'sanitize'     => 'thewebs_sanitize_toggle',
		'section'      => 'sfwd_groups_layout_design',
		'default'      => thewebs()->default( 'groups_title_featured_image' ),
	...
	'groups_title_overlay_color' => array(
		...
		'default'      => thewebs()->default( 'groups_title_overlay_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'groups_title_border' => array(
		...
		'default'      => thewebs()->default( 'groups_title_border' ),
		'context'      => array(
			array(
				'setting'    => 'groups_title',
				'operator'   => '=',
	...
	'info_sfwd_groups_layout' => array(
		...
		'section'      => 'sfwd_groups_layout',
		'priority'     => 10,
		'label'        => esc_html__( 'Group Layout', 'thewebs' ),
		'settings'     => false,
	),
	...
	'groups_layout' => array(
		...
		'transport'    => 'refresh',
		'priority'     => 10,
		'default'      => thewebs()->default( 'groups_layout' ),
		'input_attrs'  => array(
			'layout' => array(
				'normal' => array(
	...
	'groups_sidebar_id' => array(
		...
		'section'      => 'sfwd_groups_layout',
		'label'        => esc_html__( 'Group Default Sidebar', 'thewebs' ),
		'transport'    => 'refresh',
		'priority'     => 10,
		'default'      => thewebs()->default( 'groups_sidebar_id' ),
		'input_attrs'  => array(
	...
	'groups_content_style' => array(
		...
		'priority'     => 10,
		'default'      => thewebs()->default( 'groups_content_style' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
	...
	'groups_vertical_padding' => array(
		...
		'priority'     => 10,
		'default'      => thewebs()->default( 'groups_vertical_padding' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
				'selector' => 'body.single-groups',
	...
	'groups_feature' => array(
		...
		'section'      => 'sfwd_groups_layout',
		'priority'     => 20,
		'default'      => thewebs()->default( 'groups_feature' ),
	...
	'groups_feature_position' => array(
		...
		'priority'     => 20,
		'transport'    => 'refresh',
		'default'      => thewebs()->default( 'groups_feature_position' ),
		'context'      => array(
			array(
	...
	'groups_feature_ratio' => array(
		...
		'priority'     => 20,
		'default'      => thewebs()->default( 'groups_feature_ratio' ),
		'context'      => array(
			array(
				'setting'    => 'groups_feature',
				'operator'   => '=',
	...
	'groups_background' => array(
		...
		'default'      => thewebs()->default( 'groups_background' ),
		'live_method'     => array(
			array(
				'type'     => 'css_background',
				'selector' => 'body.single-groups',
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Group Background', 'thewebs' ),
		),
	),
	'groups_content_background' => array(
		...
		'default'      => thewebs()->default( 'groups_content_background' ),
		'live_method'  => array(
			array(
				'type'     => 'css_background',
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Group Content Background', 'thewebs' ),
		),
	),
);
