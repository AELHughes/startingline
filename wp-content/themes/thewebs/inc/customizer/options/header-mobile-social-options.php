...
$settings = array(
	...
	'header_mobile_social_items' => array(
		...
		'section'      => 'mobile_social',
		'priority'     => 6,
		'default'      => thewebs()->default( 'header_mobile_social_items' ),
		'label'        => esc_html__( 'Social Items', 'thewebs' ),
		'partial'      => array(
			'selector'            => '.header-mobile-social-wrap',
			'container_inclusive' => true,
			'render_callback'     => 'Thewebs\mobile_social',
		),
	),
	'header_mobile_social_show_label' => array(
		...
		'section'      => 'mobile_social',
		'priority'     => 8,
		'default'      => thewebs()->default( 'header_mobile_social_show_label' ),
	...
	'header_mobile_social_item_spacing' => array(
		...
		'default'      => thewebs()->default( 'header_mobile_social_item_spacing' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'header_mobile_social_style' => array(
		...
		'section'      => 'mobile_social',
		'priority'     => 10,
		'default'      => thewebs()->default( 'header_mobile_social_style' ),
	...
	'header_mobile_social_icon_size' => array(
		...
		'default'      => thewebs()->default( 'header_mobile_social_icon_size' ),
		'input_attrs'  => array(
			'min'        => array(
				'px'  => 0,
				'em'  => 0,
	...
	'header_mobile_social_brand' => array(
		...
		'section'      => 'mobile_social_design',
		'transport'    => 'refresh',
		'default'      => thewebs()->default( 'header_mobile_social_brand' ),
	...
	'header_mobile_social_color' => array(
		...
		'default'      => thewebs()->default( 'header_mobile_social_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'header_mobile_social_background' => array(
		...
		'default'      => thewebs()->default( 'header_mobile_social_background' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.header-mobile-social-wrap a.social-button',
	...
	'header_mobile_social_border_colors' => array(
		...
		'default'      => thewebs()->default( 'header_mobile_social_border' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'header_mobile_social_border_radius' => array(
		...
		'default'      => thewebs()->default( 'header_mobile_social_border_radius' ),
		'input_attrs'  => array(
			'min'        => array(
				'px'  => 0,
				'em'  => 0,
	...
	'header_mobile_social_typography' => array(
		...
		'default'      => thewebs()->default( 'header_mobile_social_typography' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
	...
	'header_mobile_social_margin' => array(
		...
		'section'      => 'mobile_social_design',
		'priority'     => 10,
		'default'      => thewebs()->default( 'header_mobile_social_margin' ),
