...
$settings = array(
	...
	'header_social_items' => array(
		...
		'section'      => 'header_social',
		'priority'     => 6,
		'default'      => thewebs()->default( 'header_social_items' ),
		'label'        => esc_html__( 'Social Items', 'thewebs' ),
		'partial'      => array(
			'selector'            => '.header-social-wrap',
			'container_inclusive' => true,
			'render_callback'     => 'Thewebs\header_social',
		),
	),
	'header_social_show_label' => array(
		...
		'section'      => 'header_social',
		'priority'     => 8,
		'default'      => thewebs()->default( 'header_social_show_label' ),
	...
	'header_social_item_spacing' => array(
		...
		'default'      => thewebs()->default( 'header_social_item_spacing' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'header_social_style' => array(
		...
		'section'      => 'header_social_design',
		'priority'     => 10,
		'default'      => thewebs()->default( 'header_social_style' ),
	...
	'header_social_icon_size' => array(
		...
		'default'      => thewebs()->default( 'header_social_icon_size' ),
		'input_attrs'  => array(
			'min'        => array(
				'px'  => 0,
				'em'  => 0,
	...
	'header_social_brand' => array(
		...
		'section'      => 'header_social_design',
		'transport'    => 'refresh',
		'default'      => thewebs()->default( 'header_social_brand' ),
	...
	'header_social_color' => array(
		...
		'default'      => thewebs()->default( 'header_social_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'header_social_background' => array(
		...
		'default'      => thewebs()->default( 'header_social_background' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '#main-header .header-social-wrap a.social-button',
	...
	'header_social_border_colors' => array(
		...
		'default'      => thewebs()->default( 'header_social_border' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '#main-header .header-social-wrap a.social-button',
	...
	'header_social_border_radius' => array(
		...
		'default'      => thewebs()->default( 'header_social_border_radius' ),
		'input_attrs'  => array(
			'min'        => array(
				'px'  => 0,
				'em'  => 0,
	...
	'header_social_typography' => array(
		...
		'default'      => thewebs()->default( 'header_social_typography' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
	...
	'header_social_margin' => array(
		...
		'section'      => 'header_social_design',
		'priority'     => 10,
		'default'      => thewebs()->default( 'header_social_margin' ),
