...
$settings = array(
	...
	'info_tribe_events_title' => array(
		...
		'section'      => 'tribe_events_layout',
		'priority'     => 2,
		'label'        => esc_html__( 'Event Title', 'thewebs' ),
		'settings'     => false,
	),
	...
	'tribe_events_title' => array(
		...
		'section'      => 'tribe_events_layout',
		'priority'     => 3,
		'default'      => thewebs()->default( 'tribe_events_title' ),
		'label'        => esc_html__( 'Show Event Title?', 'thewebs' ),
		'transport'    => 'refresh',
	),
	'tribe_events_title_layout' => array(
		'control_type' => 'thewebs_radio_icon_control',
		'section'      => 'tribe_events_layout',
		'label'        => esc_html__( 'Event Title Layout', 'thewebs' ),
		'transport'    => 'refresh',
		'priority'     => 4,
		'default'      => thewebs()->default( 'tribe_events_title_layout' ),
		'context'      => array(
			array(
	...
	'tribe_events_title_inner_layout' => array(
		...
		'section'      => 'tribe_events_layout',
		'priority'     => 4,
		'default'      => thewebs()->default( 'tribe_events_title_inner_layout' ),
	...
	'tribe_events_title_align' => array(
		'control_type' => 'thewebs_radio_icon_control',
		'section'      => 'tribe_events_layout',
		'label'        => esc_html__( 'Event Title Align', 'thewebs' ),
		'priority'     => 4,
		'default'      => thewebs()->default( 'tribe_events_title_align' ),
		'context'      => array(
			array(
				'setting'    => 'tribe_events_title',
				'operator'   => '=',
	...
	'tribe_events_title_height' => array(
		...
		'default'      => thewebs()->default( 'tribe_events_title_height' ),
		'input_attrs'  => array(
			'min'     => array(
				'px'  => 10,
				'em'  => 1,
	...
	'tribe_events_title_elements' => array(
		...
		'section'      => 'tribe_events_layout',
		'priority'     => 6,
		'default'      => thewebs()->default( 'tribe_events_title_elements' ),
	...
	'tribe_events_title_font' => array(
		...
		'section'      => 'tribe_events_layout_design',
		'label'        => esc_html__( 'Event Title Font', 'thewebs' ),
		'default'      => thewebs()->default( 'tribe_events_title_font' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
	...
	'tribe_events_title_breadcrumb_color' => array(
		...
		'default'      => thewebs()->default( 'tribe_events_title_breadcrumb_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.tribe_events-title .thewebs-breadcrumbs',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'color',
			),
			array(
				'type'     => 'css',
				'selector' => '.tribe_events-title .thewebs-breadcrumbs a:hover',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'hover',
			),
	...
	'tribe_events_title_breadcrumb_font' => array(
		...
		'default'      => thewebs()->default( 'tribe_events_title_breadcrumb_font' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
				'selector' => '.tribe_events-title .thewebs-breadcrumbs',
	...
	'tribe_events_title_back_link_color' => array(
		'control_type' => 'thewebs_color_control',
		'section'      => 'tribe_events_layout_design',
		'label'        => esc_html__( 'Back Link Colors', 'thewebs' ),
		'default'      => thewebs()->default( 'tribe_events_title_back_link_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'tribe_events_title_back_link_font' => array(
		'control_type' => 'thewebs_typography_control',
		'section'      => 'tribe_events_layout_design',
		'label'        => esc_html__( 'Back Link Font', 'thewebs' ),
		'default'      => thewebs()->default( 'tribe_events_title_back_link_font' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
				'selector' => '.tribe_events-title .tribe-events-back a',
	...
	'tribe_events_title_background' => array(
		...
		'section'      => 'tribe_events_layout_design',
		'label'        => esc_html__( 'Event Above Area Background', 'thewebs' ),
		'default'      => thewebs()->default( 'tribe_events_title_background' ),
		'context'      => array(
			array(
				'setting'    => 'tribe_events_title',
				'operator'   => '=',
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Event Title Background', 'thewebs' ),
		),
	),
	'tribe_events_title_featured_image' => array(
		...
		'sanitize'     => 'thewebs_sanitize_toggle',
		'section'      => 'tribe_events_layout_design',
		'default'      => thewebs()->default( 'tribe_events_title_featured_image' ),
	...
	'tribe_events_title_overlay_color' => array(
		...
		'default'      => thewebs()->default( 'tribe_events_title_overlay_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'tribe_events_title_border' => array(
		...
		'default'      => thewebs()->default( 'tribe_events_title_border' ),
		'context'      => array(
			array(
				'setting'    => 'tribe_events_title',
				'operator'   => '=',
	...
	'info_tribe_events_layout' => array(
		...
		'section'      => 'tribe_events_layout',
		'priority'     => 10,
		'label'        => esc_html__( 'Event Layout', 'thewebs' ),
		'settings'     => false,
	),
	...
	'tribe_events_layout' => array(
		...
		'transport'    => 'refresh',
		'priority'     => 10,
		'default'      => thewebs()->default( 'tribe_events_layout' ),
		'input_attrs'  => array(
			'layout' => array(
				'normal' => array(
	...
	'tribe_events_sidebar_id' => array(
		...
		'section'      => 'tribe_events_layout',
		'label'        => esc_html__( 'Event Default Sidebar', 'thewebs' ),
		'transport'    => 'refresh',
		'priority'     => 10,
		'default'      => thewebs()->default( 'tribe_events_sidebar_id' ),
		'input_attrs'  => array(
	...
	'tribe_events_content_style' => array(
		...
		'priority'     => 10,
		'default'      => thewebs()->default( 'tribe_events_content_style' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
	...
	'tribe_events_vertical_padding' => array(
		...
		'priority'     => 10,
		'default'      => thewebs()->default( 'tribe_events_vertical_padding' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
				'selector' => 'body.single-tribe_events',
	...
	// 	'section'      => 'tribe_events_layout',
	// 	'priority'     => 20,
	// 	'default'      => thewebs()->default( 'tribe_events_feature' ),
	...
	// 	'priority'     => 20,
	// 	'transport'    => 'refresh',
	// 	'default'      => thewebs()->default( 'tribe_events_feature_position' ),
	// 	'context'      => array(
	// 		array(
	...
	// 	'priority'     => 20,
	// 	'default'      => thewebs()->default( 'tribe_events_feature_ratio' ),
	// 	'context'      => array(
	// 		array(
	// 			'setting'    => 'tribe_events_feature',
	// 			'operator'   => '=',
	...
	'tribe_events_background' => array(
		...
		'default'      => thewebs()->default( 'tribe_events_background' ),
		'live_method'     => array(
			array(
				'type'     => 'css_background',
				'selector' => 'body.single-tribe_events',
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Event Background', 'thewebs' ),
		),
	),
	'tribe_events_content_background' => array(
		...
		'default'      => thewebs()->default( 'tribe_events_content_background' ),
		'live_method'  => array(
			array(
				'type'     => 'css_background',
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Event Content Background', 'thewebs' ),
		),
	),
);
