...
$settings = array(
	...
	'woo_store_notice_placement' => array(
		...
		'section'      => 'woocommerce_store_notice',
		'transport'    => 'refresh',
		'default'      => thewebs()->default( 'woo_store_notice_placement' ),
		'label'        => esc_html__( 'Store Notice Placement', 'thewebs' ),
		'input_attrs'  => array(
			'layout' => array(
				'standard' => array(
					'tooltip' => __( 'Hangs down over the top of the header', 'thewebs' ),
					'name'    => __( 'Hang Over Top', 'thewebs' ),
					'icon'    => '',
				),
				'above' => array(
					'tooltip' => __( 'Placed above the Header', 'thewebs' ),
					'name'    => __( 'Above', 'thewebs' ),
					'icon'    => '',
				),
				'bottom' => array(
					'tooltip' => __( 'Stuck to the Bottom of the screen', 'thewebs' ),
					'name'    => __( 'Bottom', 'thewebs' ),
					'icon'    => '',
				),
			),
			'responsive' => false,
	...
	'woo_store_notice_hide_dismiss' => array(
		...
		'section'      => 'woocommerce_store_notice',
		'default'      => thewebs()->default( 'woo_store_notice_hide_dismiss' ),
		'label'        => esc_html__( 'Disable Dismiss Button?', 'thewebs' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
	...
	'woo_store_notice_font' => array(
		...
		'section'      => 'woocommerce_store_notice_design',
		'label'        => esc_html__( 'Notice Font', 'thewebs' ),
		'default'      => thewebs()->default( 'woo_store_notice_font' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
	...
	'woo_store_notice_background' => array(
		...
		'section'      => 'woocommerce_store_notice_design',
		'label'        => esc_html__( 'Background Color', 'thewebs' ),
		'default'      => thewebs()->default( 'woo_store_notice_background' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
