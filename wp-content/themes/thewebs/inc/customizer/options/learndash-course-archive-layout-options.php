...
$settings = array(
	...
	'sfwd-courses_archive_title' => array(
		...
		'section'      => 'sfwd_courses_archive_layout',
		'priority'     => 3,
		'default'      => thewebs()->default( 'sfwd-courses_archive_title' ),
	...
	'sfwd-courses_archive_title_layout' => array(
		...
		'transport'    => 'refresh',
		'priority'     => 4,
		'default'      => thewebs()->default( 'sfwd-courses_archive_title_layout' ),
		'context'      => array(
			array(
	...
	'sfwd-courses_archive_title_inner_layout' => array(
		...
		'section'      => 'sfwd_courses_archive_layout',
		'priority'     => 4,
		'default'      => thewebs()->default( 'sfwd-courses_archive_title_inner_layout' ),
	...
	'sfwd-courses_archive_title_align' => array(
		...
		'priority'     => 4,
		'default'      => thewebs()->default( 'sfwd-courses_archive_title_align' ),
		'context'      => array(
			array(
				'setting'    => 'sfwd-courses_archive_title',
				'operator'   => '=',
	...
	'sfwd-courses_archive_title_height' => array(
		...
		'default'      => thewebs()->default( 'sfwd-courses_archive_title_height' ),
		'input_attrs'  => array(
			'min'     => array(
				'px'  => 10,
				'em'  => 1,
	...
	'sfwd-courses_archive_title_elements' => array(
		...
		'section'      => 'sfwd_courses_archive_layout',
		'priority'     => 6,
		'default'      => thewebs()->default( 'sfwd-courses_archive_title_elements' ),
	...
	'sfwd-courses_archive_title_color' => array(
		...
		'default'      => thewebs()->default( 'sfwd-courses_archive_title_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'sfwd-courses_archive_title_description_color' => array(
		...
		'default'      => thewebs()->default( 'sfwd-courses_archive_title_description_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'sfwd-courses_archive_title_breadcrumb_color' => array(
		...
		'default'      => thewebs()->default( 'sfwd-courses_archive_title_breadcrumb_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.sfwd-courses-archive-title .thewebs-breadcrumbs',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'color',
			),
			array(
				'type'     => 'css',
				'selector' => '.sfwd-courses-archive-title .thewebs-breadcrumbs a:hover',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'hover',
			),
	...
	'sfwd-courses_archive_title_background' => array(
		...
		'default'      => thewebs()->default( 'sfwd-courses_archive_title_background' ),
		'context'      => array(
			array(
				'setting'    => 'sfwd-courses_archive_title',
				'operator'   => '=',
	...
	'sfwd-courses_archive_title_overlay_color' => array(
		...
		'default'      => thewebs()->default( 'sfwd-courses_archive_title_overlay_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'sfwd-courses_archive_title_border' => array(
		...
		'default'      => thewebs()->default( 'sfwd-courses_archive_title_border' ),
		'context'      => array(
			array(
				'setting'    => 'sfwd-courses_archive_title',
				'operator'   => '=',
	...
	'sfwd-courses_archive_layout' => array(
		...
		'transport'    => 'refresh',
		'priority'     => 10,
		'default'      => thewebs()->default( 'sfwd-courses_archive_layout' ),
		'input_attrs'  => array(
			'layout' => array(
				'normal' => array(
	...
	'sfwd-courses_archive_content_style' => array(
		...
		'priority'     => 10,
		'default'      => thewebs()->default( 'sfwd-courses_archive_content_style' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
	...
	'sfwd-courses_archive_columns' => array(
		...
		'transport'    => 'refresh',
		'default'      => thewebs()->default( 'sfwd-courses_archive_columns' ),
		'input_attrs'  => array(
			'layout' => array(
				'2' => array(
					'name' => __( '2', 'thewebs' ),
	...
	'sfwd-courses_archive_background' => array(
		...
		'default'      => thewebs()->default( 'sfwd-courses_archive_background' ),
		'live_method'     => array(
			array(
				'type'     => 'css_background',
				'selector' => 'body.post-type-archive-sfwd-courses',
	...
	'sfwd-courses_archive_content_background' => array(
		...
		'default'      => thewebs()->default( 'sfwd-courses_archive_content_background' ),
		'live_method'  => array(
			array(
				'type'     => 'css_background',
