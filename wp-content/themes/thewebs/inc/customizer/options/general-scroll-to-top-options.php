...
Theme_Customizer::add_settings(
	array(
		...
		'scroll_up' => array(
			...
			'section'      => 'scroll_up',
			'default'      => thewebs()->default( 'scroll_up' ),
			'label'        => esc_html__( 'Enable Scroll To Top', 'thewebs' ),
			'transport'    => 'refresh',
		),
		'scroll_up_icon' => array(
			...
			'section'      => 'scroll_up',
			'priority'     => 10,
			'default'      => thewebs()->default( 'scroll_up_icon' ),
			'label'        => esc_html__( 'Scroll Up Icon', 'thewebs' ),
			'partial'      => array(
				'selector'            => '.scroll-up-wrap',
				'container_inclusive' => true,
				'render_callback'     => 'Thewebs\scroll_up',
			),
			'context'      => array(
				array(
					'setting'  => 'scroll_up',
		...
		'scroll_up_icon_size' => array(
			...
			'default'      => thewebs()->default( 'scroll_up_icon_size' ),
			'input_attrs'  => array(
				'min'        => array(
					'px'  => 0,
					'em'  => 0,
		...
		'scroll_up_side' => array(
			'control_type' => 'thewebs_radio_icon_control',
			'section'      => 'scroll_up',
			'default'      => thewebs()->default( 'scroll_up_side' ),
			'label'        => esc_html__( 'Align', 'thewebs' ),
			'context'      => array(
				array(
					'setting'  => 'scroll_up',
					'operator' => '==',
		...
		'scroll_up_side_offset' => array(
			'control_type' => 'thewebs_range_control',
			'section'      => 'scroll_up',
			'label'        => esc_html__( 'Side Offset', 'thewebs' ),
			'default'      => thewebs()->default( 'scroll_up_side_offset' ),
			'context'      => array(
				array(
					'setting'  => 'scroll_up',
					'operator' => '==',
		...
		'scroll_up_bottom_offset' => array(
			'control_type' => 'thewebs_range_control',
			'section'      => 'scroll_up',
			'label'        => esc_html__( 'Bottom Offset', 'thewebs' ),
			'default'      => thewebs()->default( 'scroll_up_bottom_offset' ),
			'context'      => array(
				array(
					'setting'  => 'scroll_up',
					'operator' => '==',
		...
		'scroll_up_visiblity' => array(
			...
			'section'      => 'scroll_up',
			'default'      => thewebs()->default( 'scroll_up_visiblity' ),
			'label'        => esc_html__( 'Visibility', 'thewebs' ),
			'context'      => array(
				array(
					'setting'  => 'scroll_up',
					'operator' => '==',
		...
		'scroll_up_style' => array(
			'control_type' => 'thewebs_radio_icon_control',
			'section'      => 'scroll_up_design',
			'default'      => thewebs()->default( 'scroll_up_style' ),
			'label'        => esc_html__( 'Scroll Button Style', 'thewebs' ),
			'live_method'     => array(
				array(
					'type'     => 'class',
					'selector' => '#kt-scroll-up-reader, #kt-scroll-up',
		...
		'scroll_up_color' => array(
			...
			'default'      => thewebs()->default( 'scroll_up_color' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '#kt-scroll-up-reader, #kt-scroll-up',
		...
		'scroll_up_background' => array(
			...
			'default'      => thewebs()->default( 'scroll_up_background' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '#kt-scroll-up-reader, #kt-scroll-up',
		...
		'scroll_up_border_colors' => array(
			...
			'default'      => thewebs()->default( 'scroll_up_border' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '#kt-scroll-up-reader, #kt-scroll-up',
		...
		'scroll_up_radius' => array(
			...
			'section'      => 'scroll_up_design',
			'priority'     => 10,
			'default'      => thewebs()->default( 'scroll_up_radius' ),
		...
		'scroll_up_padding' => array(
			...
			'section'      => 'scroll_up_design',
			'priority'     => 10,
			'default'      => thewebs()->default( 'scroll_up_padding' ),
			'label'        => esc_html__( 'Scroll Button Padding', 'thewebs' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '#kt-scroll-up-reader, #kt-scroll-up',
